...
export default function ShowroomMap({ selectedShowroom, onSelectShowroom }) {
  ...
  return (
    <div className="w-full bg-[#1a1a1a] rounded-2xl border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row h-full min-h-[380px]">
      ...
      <div className="w-full md:w-7/12 bg-transparent relative p-6 flex flex-col justify-between">
        <div>
          <div className="inline-block px-3 py-1 bg-white/5 text-gray-400 border border-white/10 rounded-full text-[9px] uppercase font-bold tracking-widest mb-4">
            Showroom Được Chọn
          </div>
          <h3 className="text-xl font-bold text-white mb-2">{selectedShowroom}</h3>
          <p className="text-sm text-gray-400 leading-relaxed mb-6">{details.address}</p>
          
          <div className="flex items-center gap-3 text-sm text-white font-medium">
            <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-red-500">
