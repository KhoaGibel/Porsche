          ...
          <div className="w-full md:w-[320px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <div className="flex gap-2.5">
                <a href="https://www.facebook.com/Official.Porsche.Importer.Vietnam" className="flex justify-center items-center w-[46px] h-[46px] bg-white/5 text-white border border-white/10 transition-colors duration-300 hover:bg-white hover:text-black group">
                ...
                <a href="https://www.youtube.com/@Porsche" className="flex justify-center items-center w-[46px] h-[46px] bg-white/5 text-white border border-white/10 transition-colors duration-300 hover:bg-white hover:text-black group">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 transition-transform group-hover:scale-110">
                    <path d="M21.58 7.19c-.23-.86-.91-1.54-1.77-1.77C18.25 5 12 5 12 5s-6.25 0-7.81.42c-.86.23-1.54.91-1.77 1.77C2 8.75 2 12 2 12s0 3.25.42 4.81c.23.86.91 1.54 1.77 1.77C5.75 19 12 19 12 19s6.25 0 7.81-.42c.86-.23 1.54-.91 1.77-1.77C22 15.25 22 12 22 12s0-3.25-.42-4.81zM10 15V9l5.2 3-5.2 3z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/porsche_vietnam/" className="flex justify-center items-center w-[46px] h-[46px] bg-white/5 text-white border border-white/10 transition-colors duration-300 hover:bg-white hover:text-black group">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 transition-transform group-hover:scale-110">
