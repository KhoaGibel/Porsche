...
var viem = require('@lens-chain/sdk/viem');
var graphql_star = require('@lens-protocol/graphql');
var testUtils = require('@lens-protocol/graphql/test-utils');
var types_star = require('@lens-protocol/types');
var graphql = require('graphql');
var viem$1 = require('viem');
var accounts = require('viem/accounts');
var env_star = require('@lens-protocol/env');
var jwtDecode = require('jwt-decode');
var introspectedSchema = require('@lens-protocol/graphql/schema');
...
var graphql_star__namespace = /*#__PURE__*/_interopNamespace(graphql_star);
var types_star__namespace = /*#__PURE__*/_interopNamespace(types_star);
var env_star__namespace = /*#__PURE__*/_interopNamespace(env_star);
var introspectedSchema__default = /*#__PURE__*/_interopDefault(introspectedSchema);
...
var require_stringify = __commonJS({
  "../../node_modules/.pnpm/jsonify@0.0.1/node_modules/jsonify/lib/stringify.js"(exports, module) {
    ...
    function quote(string2) {
      ...
      return escapable.test(string2) ? '"' + string2.replace(escapable, function(a4) {
        var c2 = meta[a4];
  ...
  "../../node_modules/.pnpm/object-keys@1.1.1/node_modules/object-keys/implementation.js"(exports, module) {
    ...
    if (!Object.keys) {
      ...
      keysShim = function keys2(object2) {
        ...
        var isString = isObject4 && toStr.call(object2) === "[object String]";
        var theKeys = [];
...
var require_abs = __commonJS({
  "../../node_modules/.pnpm/math-intrinsics@1.0.0/node_modules/math-intrinsics/abs.js"(exports, module) {
...
var require_floor = __commonJS({
  "../../node_modules/.pnpm/math-intrinsics@1.0.0/node_modules/math-intrinsics/floor.js"(exports, module) {
...
var require_max = __commonJS({
  "../../node_modules/.pnpm/math-intrinsics@1.0.0/node_modules/math-intrinsics/max.js"(exports, module) {
...
var require_min = __commonJS({
  "../../node_modules/.pnpm/math-intrinsics@1.0.0/node_modules/math-intrinsics/min.js"(exports, module) {
...
var require_pow = __commonJS({
  "../../node_modules/.pnpm/math-intrinsics@1.0.0/node_modules/math-intrinsics/pow.js"(exports, module) {
...
var require_implementation2 = __commonJS({
  "../../node_modules/.pnpm/function-bind@1.1.2/node_modules/function-bind/implementation.js"(exports, module) {
    ...
    var concatty = function concatty2(a4, b) {
      var arr = [];
      for (var i2 = 0; i2 < a4.length; i2 += 1) {
        arr[i2] = a4[i2];
      }
      for (var j2 = 0; j2 < b.length; j2 += 1) {
        arr[j2 + a4.length] = b[j2];
      }
      return arr;
    };
...
var require_hasown = __commonJS({
  "../../node_modules/.pnpm/hasown@2.0.2/node_modules/hasown/index.js"(exports, module) {
    ...
    var bind = require_function_bind();
    module.exports = bind.call(call2, $hasOwn);
  }
});
...
var require_json_stable_stringify = __commonJS({
  "../../node_modules/.pnpm/json-stable-stringify@1.1.1/node_modules/json-stable-stringify/index.js"(exports, module) {
    ...
    var strRepeat = function repeat(n3, char) {
      var str = "";
      for (var i2 = 0; i2 < n3; i2 += 1) {
        str += char;
      }
      return str;
    };
      ...
      return function stringify2(parent, key, node, level) {
        ...
        if (isArray(node)) {
          ...
          for (var i2 = 0; i2 < node.length; i2++) {
            var item = stringify2(node, i2, node[i2], level + 1) || jsonStringify(null);
...
var BitSet, Chunk, btoa2, SourceMap, toString4, wordRegex, Mappings, n2, warned, MagicString, hasOwnProp, Bundle;
  ...
  "../../node_modules/.pnpm/magic-string@0.30.17/node_modules/magic-string/dist/magic-string.es.mjs"() {
    ...
    Bundle = class _Bundle {
      ...
      getIndentString() {
        ...
        return Object.keys(indentStringCounts).sort((a4, b) => {
          return indentStringCounts[a4] - indentStringCounts[b];
        })[0] || "	";
      }
      indent(indentStr) {
        if (!arguments.length) {
...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.2.1/node_modules/expect-type/dist/index.js"(exports) {
    ...
    var __exportStar = exports && exports.__exportStar || function(m2, exports2) {
      for (var p4 in m2) if (p4 !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p4)) __createBinding(exports2, m2, p4);
    };
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/@lens-chain+storage-client@1.0.5/node_modules/@lens-chain/storage-client/dist/index.js
...
var BaseError = class _BaseError extends Error {
  ...
  static formatMessage(cause) {
    ...
    while (currentError instanceof Error) {
      messages2.push(currentError.message);
      currentError = currentError.cause;
    }
    return messages2.join(" due to ");
  }
};
...
var AuthorizationService = class {
  ...
  async authorize(action, storageKey, signer2) {
...
function createAclTemplateContent(acl2) {
  switch (acl2.template) {
    case "generic_acl":
      return {
        template: acl2.template,
        contract_address: acl2.contractAddress,
        chain_id: acl2.chainId,
        network_type: "evm",
        function_sig: acl2.functionSig,
        params: acl2.params
      };
    case "lens_account":
      return {
        template: acl2.template,
        lens_account: acl2.lensAccount,
        chain_id: acl2.chainId
      };
    case "wallet_address":
      return {
        template: acl2.template,
        wallet_address: acl2.walletAddress,
        chain_id: acl2.chainId
      };
    case "immutable":
      return {
    ...
    default:
      never(`Unknown ACL template: ${acl2}`);
  }
}
...
var MultipartEntriesBuilder = class _MultipartEntriesBuilder {
  ...
  withIndexFile(index2) {
    const file = index2 instanceof File ? index2 : createIndexFile(
      index2 === true ? createDefaultIndexContent(this.allocations) : index2.call(null, this.allocations.slice())
      // shallow copy
    );
...
var StorageClient = class _StorageClient {
  ...
  async uploadFile(file, { acl: acl2 } = { acl: immutable(this.env.defaultChainId) }) {
    const resource = acl2.template === "immutable" ? await this.uploadImmutableFile(file, acl2) : await this.uploadMutableFile(file, acl2);
   ...
   */
  async delete(storageKeyOrUri, signer2) {
    const storageKey = extractStorageKey(storageKeyOrUri);
    const authorization = await this.authorization.authorize("delete", storageKey, signer2);
   ...
   */
  async updateJson(storageKeyOrUri, json, signer2, options) {
    const file = new File([JSON.stringify(json)], options.name ?? "data.json", {
      type: "application/json"
    });
    return this.editFile(storageKeyOrUri, file, signer2, options);
  }
  async editFile(storageKeyOrUri, newFile, signer2, options = { acl: immutable(this.env.defaultChainId) }) {
    const storageKey = extractStorageKey(storageKeyOrUri);
    const authorization = await this.authorization.authorize("edit", storageKey, signer2);
  ...
  async uploadMutableFile(file, acl2) {
    const [resource] = await this.allocateStorage(1);
    const builder = MultipartEntriesBuilder.from([resource]).withFile(file).withAclTemplate(acl2);
    const entries = builder.build();
  ...
  async create(storageKey, entries) {
...
var ZodError = class _ZodError extends Error {
  ...
  format(_mapper) {
    ...
    const processError2 = (error) => {
      for (const issue of error.issues) {
        if (issue.code === "invalid_union") {
          issue.unionErrors.map(processError2);
        } else if (issue.code === "invalid_return_type") {
          processError2(issue.returnTypeError);
        } else if (issue.code === "invalid_arguments") {
          processError2(issue.argumentsError);
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/version.js
var version = "1.0.8";

// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/errors.js
var BaseError2 = class _BaseError2 extends Error {
  constructor(shortMessage, args = {}) {
    ...
    const docsPath = args.cause instanceof _BaseError2 ? args.cause.docsPath || args.docsPath : args.docsPath;
    const message = [
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/regex.js
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/formatAbiParameter.js
var tupleRegex = /^tuple(?<array>(\[(\d*)\])*)$/;
function formatAbiParameter(abiParameter) {
  let type3 = abiParameter.type;
  if (tupleRegex.test(abiParameter.type) && "components" in abiParameter) {
    type3 = "(";
    const length = abiParameter.components.length;
    for (let i2 = 0; i2 < length; i2++) {
      const component = abiParameter.components[i2];
      type3 += formatAbiParameter(component);
      if (i2 < length - 1)
        type3 += ", ";
    }
  ...
  if (abiParameter.name)
    return `${type3} ${abiParameter.name}`;
  return type3;
}

// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/formatAbiParameters.js
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/runtime/signatures.js
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/errors/abiItem.js
var UnknownTypeError = class extends BaseError2 {
  constructor({ type: type3 }) {
    super("Unknown type.", {
      metaMessages: [
        `Type "${type3}" is not a valid ABI type. Perhaps you forgot to include a struct signature?`
      ]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
var UnknownSolidityTypeError = class extends BaseError2 {
  constructor({ type: type3 }) {
    super("Unknown type.", {
      metaMessages: [`Type "${type3}" is not a valid ABI type.`]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/errors/abiParameter.js
...
var InvalidModifierError = class extends BaseError2 {
  constructor({ param, type: type3, modifier }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
        `Modifier "${modifier}" not allowed${type3 ? ` in "${type3}" type` : ""}.`
      ]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/errors/signature.js
var InvalidSignatureError = class extends BaseError2 {
  constructor({ signature, type: type3 }) {
    super(`Invalid ${type3} signature.`, {
      details: signature
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/errors/struct.js
var CircularReferenceError = class extends BaseError2 {
  constructor({ type: type3 }) {
    super("Circular reference detected.", {
      metaMessages: [`Struct "${type3}" is a circular reference.`]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/errors/splitParameters.js
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/runtime/cache.js
function getParameterCacheKey(param, type3, structs) {
  let structKey = "";
  if (structs)
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/runtime/utils.js
...
function parseAbiParameter(param, options) {
  ...
  if (isTuple) {
    ...
    type3 = `${match.type}256`;
  } else {
    type3 = match.type;
    if (!(options?.type === "struct") && !isSolidityType(type3))
      throw new UnknownSolidityTypeError({ type: type3 });
  }
  if (match.modifier) {
    ...
    if (functionModifiers.has(match.modifier) && !isValidDataLocation(type3, !!match.array))
...
function isSolidityType(type3) {
  return type3 === "address" || type3 === "bool" || type3 === "function" || type3 === "string" || bytesRegex.test(type3) || integerRegex.test(type3);
}
var protectedKeywordsRegex = /^(?:after|alias|anonymous|apply|auto|byte|calldata|case|catch|constant|copyof|default|defined|error|event|external|false|final|function|immutable|implements|in|indexed|inline|internal|let|mapping|match|memory|mutable|null|of|override|partial|private|promise|public|pure|reference|relocatable|return|returns|sizeof|static|storage|struct|super|supports|switch|this|true|try|typedef|typeof|var|view|virtual)$/;
function isSolidityKeyword(name) {
  return name === "address" || name === "bool" || name === "function" || name === "string" || name === "tuple" || bytesRegex.test(name) || integerRegex.test(name) || protectedKeywordsRegex.test(name);
}
function isValidDataLocation(type3, isArray) {
  return isArray || type3 === "bytes" || type3 === "string" || type3 === "tuple";
}

// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/runtime/structs.js
...
function resolveStructs(abiParameters, structs, ancestors = /* @__PURE__ */ new Set()) {
  ...
  for (let i2 = 0; i2 < length; i2++) {
    ...
    if (isTuple)
      ...
      const { array: array2, type: type3 } = match;
      if (type3 in structs) {
        if (ancestors.has(type3))
          throw new CircularReferenceError({ type: type3 });
        components.push({
          ...abiParameter,
          type: `tuple${array2 ?? ""}`,
          components: resolveStructs(structs[type3] ?? [], structs, /* @__PURE__ */ new Set([...ancestors, type3]))
        });
      } else {
        if (isSolidityType(type3))
          components.push(abiParameter);
        else
          throw new UnknownTypeError({ type: type3 });
      }
    }
  }
  return components;
...
// ../../node_modules/.pnpm/abitype@1.0.8_typescript@5.7.2_zod@3.23.8/node_modules/abitype/dist/esm/human-readable/parseAbiParameters.js
...
// ../../node_modules/.pnpm/@lens-protocol+metadata@2.0.0_typescript@5.7.2_zod@3.23.8/node_modules/@lens-protocol/metadata/dist/index.js
__toESM(require_json_stable_stringify());
var g = "https://json-schemas.lens.dev";
var K = ((t) => (t[t.LATEST = `${g}/actions/1.0.0.json`] = "LATEST", t))(K || {});
function oe(e) {
  return e.length > 0;
}
function Xe(e) {
...
var Ct = /[$_\p{ID_Start}][$\u200c\u200d\p{ID_Continue}]*/u;
function Ue(e) {
  return e.length === 1 ? e[0].toString() : e.reduce((t, r) => {
    if (typeof r == "number") return `${t}[${r.toString()}]`;
    if (r.includes('"')) return `${t}["${Rt(r)}"]`;
    if (!Ct.test(r)) return `${t}["${r}"]`;
    let o = t.length === 0 ? "" : ".";
    return t + o + r;
  }, "");
}
function Nt(e) {
  let t = e.unionErrors.map((x) => x.issues.map((y) => oe(y.path) ? `"${Ue(y.path)}": ${y.message}` : y.message)), r = [...new Set(t.map((x) => x.join("; ")))], o = Array.isArray(e.path) ? e.path : [e.path], S = oe(o) ? `"${Ue(o)}": ` : "";
  return Xe(r) ? `${we}${S}expected to match one of the following groups:
		${r.join(`${Oe}	OR:${Oe}		`)}` : `${we}${S}${r[0]}`;
}
function _t(e) {
  return e.code === z.ZodIssueCode.invalid_union ? Nt(e) : oe(e.path) ? `${we}"${Ue(e.path)}": ${e.message}` : e.message;
}
function ie(e) {
  let t = e.errors.slice(0, xt).map((r) => _t(r)).join(Oe);
  return t.length === 0 ? `invalid argument, it was not possible to determine a more detailed reason.
...
var Ut = /^[a-z]{2}(?:-[a-zA-Z]{2})?$/;
var Ft = /^([a-z]{2})(?:-[A-Z0-9]{2,3})?$/i;
var Qe = z.string({ description: "A Locale Identifier in the `[language]` OR `[language]-[region]` format (e.g. `en`, `en-GB`, `it`). [language] MUST be in the ISO 639-1 format. [region], if provided, MUST be in the ISO 3166-1 alpha-2 format." }).regex(Ut, "Should be a valid Locale Identifier. Expected `[language]` OR `[language]-[region]` format (e.g. `en`, `en-GB`, `it`). [language] MUST be in the ISO 639-1 format. [region], if provided, MUST be in the ISO 3166-1 alpha-2 format.");
var et = Qe.catch((e) => {
  let t = Ft.exec(e.input);
  return t ? t[1] : e.input;
}).superRefine((e, t) => {
  let r = Qe.safeParse(e);
  if (!r.success) for (let o of r.error.issues) t.addIssue(o);
  return z.NEVER;
}).transform(wt);
function zt(e) {
  return z.preprocess((t, r) => {
    let o = z.string().safeParse(t);
    if (!o.success) {
      for (let S of o.error.issues) r.addIssue({ ...S, fatal: true });
      return z.NEVER;
    }
    return o.data.replace(/^[\u0000\u0007\u000e\u000f\u200b-\u200d\ufeff]*/, "").replace(/[\u0000\u0007\u000e\u000f\u200b-\u200d\ufeff]*$/, "").trim();
  }, e.min(1));
}
var a = zt(z.string());
var ze = z.string().describe("An arbitrary tag.").min(1).max(50).transform((e) => e.toLowerCase());
function Bt(e) {
  return e;
}
var M = z.string().min(1).describe("A cryptographic signature of the Lens metadata.").transform(Bt);
function Vt(e) {
  return e;
}
var n = a.transform(Vt);
function Gt(e) {
  return e;
}
var i = z.string({ description: "A Uniform Resource Identifier." }).min(6).url({ message: "Should be a valid URI" }).transform(Gt);
var Fe = /^geo:(-?\d+\.?\d*),(-?\d+\.?\d*)$/;
var tt = z.coerce.number({ description: "The latitude." }).min(-90).max(90);
var at = z.coerce.number({ description: "The longitude." }).min(-180).max(180);
var H = z.string().describe("A Geographic coordinate as subset of Geo URI (RFC 5870). Currently only supports the `geo:lat,lng` format.").regex(Fe, "Should be a Geo URI. Expected `geo:lat,lng`.").superRefine((e, t) => {
  let r = Fe.exec(e);
  if (!r) return z.NEVER;
  let [, o = "", S = ""] = r, x = tt.safeParse(o);
  if (!x.success) for (let ve of x.error.issues) t.addIssue({ ...ve, path: [...t.path, "lat"] });
  let y = at.safeParse(S);
  if (!y.success) for (let ve of y.error.issues) t.addIssue({ ...ve, path: [...t.path, "lng"] });
  return z.NEVER;
});
z.object({ lat: tt, lng: at });
var ne = z.object({ formatted: a.describe("The full mailing address formatted for display.").optional(), streetAddress: a.describe("The street address including house number, street name, P.O. Box, apartment or unit number and extended multi-line address information.").optional(), locality: a.describe("The city or locality."), region: a.describe("The state or region.").optional(), postalCode: a.describe("The zip or postal code.").optional(), country: a.describe("The country name component.") });
function jt(e) {
  return e;
}
var U = z.string().datetime().transform(jt);
function $t(e) {
  return e;
}
var ot = z.string().length(42).describe("An EVM compatible address.").transform($t);
function Zt(e) {
  return e;
}
var it = z.number().positive().transform(Zt);
function Kt(e) {
  return e;
}
var Ht = z.string().length(66).regex(/^0x[0-9a-fA-F]{64}$/, "Should be a 32 bytes long hexadecimal string.").transform(Kt);
var Wt = z.string().superRefine((e, t) => {
  try {
    let r = formatAbiParameters(parseAbiParameters(e));
    r !== e && t.addIssue({ message: `Should be a valid Solidity ABI parameters string. Expected: \`${r}\`.`, code: z.ZodIssueCode.custom });
  } catch (r) {
    if (r instanceof BaseError2 && r.metaMessages) for (let o of r.metaMessages) t.addIssue({ message: o, code: z.ZodIssueCode.custom });
    else t.addIssue({ message: String(r), code: z.ZodIssueCode.custom });
  }
  return z.NEVER;
});
var p = z.object({ key: Ht.describe("A unique 32 bytes long hexadecimal string key."), name: a.describe("The human-readable name of the parameter."), type: Wt.describe("The human-readable ABI description of the parameter.") });
var Yt = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Action."), description: n.describe("Markdown formatted description of the Action."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Action source code. Typically a GitHub repository."), configureParams: z.array(p).optional().describe("An optional list of `ContractKeyValuePairDescriptor` that describes the `params` argument of the `configure` function."), executeParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `params` argument of the `execute` function."), setDisabledParams: z.array(p).optional().describe("An optional list of `ContractKeyValuePairDescriptor` that describes the `params` argument of the `setDisabledParams` function.") });
z.object({ $schema: z.literal(K.LATEST), lens: Yt, signature: M.optional() });
var qt = ((x) => (x.BOOLEAN = "Boolean", x.DATE = "Date", x.NUMBER = "Number", x.STRING = "String", x.JSON = "JSON", x))(qt || {});
var Jt = z.object({ type: z.literal("Boolean"), key: a.describe("The attribute's unique identifier."), value: z.enum(["true", "false"]).describe("A JS boolean value serialized as string. It's consumer responsibility to parse it.") });
var Xt = z.object({ type: z.literal("Date"), key: a.describe("The attribute's unique identifier."), value: z.string().datetime().describe("A valid ISO 8601 date string.  It's consumer responsibility to parse it.") });
var Qt = z.object({ type: z.literal("Number"), key: a.describe("The attribute's unique identifier."), value: a.describe("A valid JS number serialized as string. It's consumer responsibility to parse it.") });
var ea = z.object({ type: z.literal("String"), key: a.describe("The attribute's unique identifier."), value: a.describe("Any string value.") });
var ta = z.object({ type: z.literal("JSON"), key: a.describe("The attribute's unique identifier."), value: a.describe("A JSON string. It's consumer responsibility to validate and parse it.") });
var G = z.discriminatedUnion("type", [Jt, Xt, Qt, ea, ta]);
var W = ((t) => (t[t.LATEST = `${g}/account/1.0.0.json`] = "LATEST", t))(W || {});
var aa = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("The Account display name.").optional(), bio: n.describe("The Account bio as markdown.").optional(), picture: i.describe("The Account picture.").optional(), coverPicture: i.describe("The Account cover picture.").optional(), attributes: G.array().min(1).optional().describe("A bag of attributes that can be used to store any kind of metadata that is not currently supported by the standard. Over time, common attributes will be added to the standard and their usage as arbitrary attributes will be discouraged.") }, { description: "The Lens specific metadata details." });
z.object({ $schema: z.literal(W.LATEST), lens: aa, signature: M.optional() });
var Y = ((t) => (t[t.LATEST = `${g}/app/1.0.0.json`] = "LATEST", t))(Y || {});
var ct = ((o) => (o.WEB = "web", o.IOS = "ios", o.ANDROID = "android", o))(ct || {});
var ra = z.object({ name: a.describe("The name of the app."), tagline: a.optional().describe("A memorable phrase to capture the essence of the app."), description: n.optional().describe("An optional short and detailed description of the app, explaining its features and purpose."), logo: i.optional().describe("The Logo icon for the app."), url: i.describe("The url of the app."), developer: a.describe("The Developer of the app."), platforms: z.array(z.nativeEnum(ct)).describe("The platforms supported by the app."), termsOfService: i.optional().describe("The terms of service for the app."), privacyPolicy: i.optional().describe("The privacy policy for the app.") });
z.object({ $schema: z.literal(Y.LATEST), lens: ra, signature: M.optional() });
var se = class extends Error {
  name = "ValidationError";
};
function c(e) {
  if (e.success) return e.data;
  throw new se(ie(e.error));
}
var J = ((t) => (t[t.LATEST = `${g}/feed/1.0.0.json`] = "LATEST", t))(J || {});
var sa = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("The name of the Feed."), description: a.optional().describe("Optional markdown formatted description of the Feed.") });
z.object({ $schema: z.literal(J.LATEST), lens: sa, signature: M.optional() });
var X = ((t) => (t[t.LATEST = `${g}/graph/1.0.0.json`] = "LATEST", t))(X || {});
var ma = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("The name of the graph."), description: a.optional().describe("Optional markdown formatted description of the graph.") });
z.object({ $schema: z.literal(X.LATEST), lens: ma });
var Q = ((t) => (t[t.LATEST = `${g}/group/1.0.0.json`] = "LATEST", t))(Q || {});
var da = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: z.string({ description: "The name of the Group." }).regex(/^[a-zA-Z0-9-]{1,50}$/, "Group name must be between 1 and 50 characters long and contain only alphanumeric characters and hyphens."), description: a.optional().describe("Optional markdown formatted description of the Group."), icon: i.optional().describe("Optional uri of the Group's icon."), coverPicture: i.optional().describe("Optional uri of the Group's cover picture.") });
z.object({ $schema: z.literal(Q.LATEST), lens: da, signature: M.optional() });
function lt(e) {
  return z.object({ name: z.string().describe("The name of the contract."), description: z.string().optional().describe("The description of the contract."), symbol: z.string().optional().describe("The symbol of the contract."), image: i.optional().describe("A URI pointing to a resource with mime type image/* that represents the contract, typically displayed as a profile picture for the contract."), banner_image: i.optional().describe("A URI pointing to a resource with mime type image/* that represents the contract, displayed as a banner image for the contract."), featured_image: i.optional().describe("A URI pointing to a resource with mime type image/* that represents the featured image for the contract, typically used for a highlight section."), external_link: i.optional().describe("The external link of the contract."), collaborators: ot.array().optional().describe("An array of Ethereum addresses representing collaborators (authorized editors) of the contract.") }).extend(e);
}
var ee = ((t) => (t[t.LATEST = `${g}/username/1.0.0.json`] = "LATEST", t))(ee || {});
var la = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), description: a.optional().describe("An optional description of the username Namespace.") });
lt({ $schema: z.literal(ee.LATEST), lens: la, signature: M.optional() });
var yt = ((o) => (o.NUMBER = "number", o.STRING = "string", o.DATE = "date", o))(yt || {});
var fa = z.object({ display_type: z.nativeEnum(yt).optional(), trait_type: a.optional().describe("The name of the trait."), value: z.union([z.string(), z.number()]).optional() }).passthrough();
function At(e) {
  return z.object({ description: n.describe("A human-readable description of the item. It could be plain text or markdown.").nullable().optional().catch(null), external_url: i.describe("This is the URL that will appear below the asset's image on OpenSea and others etc. and will allow users to leave OpenSea and view the item on the site.").nullable().optional().catch(null), name: z.string({ description: "Name of the NFT item." }).optional(), attributes: fa.array().optional().describe("These are the attributes for the item, which will show up on the OpenSea and others NFT trading websites on the item.").catch([]), image: i.describe("NFT will store any image here.").nullable().optional().catch(null), animation_url: i.describe("A URL to a multi-media attachment for the item. The file extensions GLTF, GLB, WEBM, MP4, M4V, OGV, and OGG are supported, along with the audio-only extensions MP3, WAV, and OGA. Animation_url also supports HTML pages, allowing you to build rich experiences and interactive NFTs using JavaScript canvas, WebGL, and more. Scripts and relative paths within the HTML page are now supported. However, access to browser extensions is not supported.").nullable().optional().catch(null) }).extend(e).passthrough();
}
var gt = ((m2) => (m2.CCO = "CCO", m2.CC_BY = "CC BY", m2.CC_BY_ND = "CC BY-ND", m2.CC_BY_NC = "CC BY-NC", m2.TBNL_C_D_PL_Legal = "TBNL-C-D-PL-Legal", m2.TBNL_C_DT_PL_Legal = "TBNL-C-DT-PL-Legal", m2.TBNL_C_ND_PL_Legal = "TBNL-C-ND-PL-Legal", m2.TBNL_C_D_NPL_Legal = "TBNL-C-D-NPL-Legal", m2.TBNL_C_DT_NPL_Legal = "TBNL-C-DT-NPL-Legal", m2.TBNL_C_DTSA_PL_Legal = "TBNL-C-DTSA-PL-Legal", m2.TBNL_C_DTSA_NPL_Legal = "TBNL-C-DTSA-NPL-Legal", m2.TBNL_C_ND_NPL_Legal = "TBNL-C-ND-NPL-Legal", m2.TBNL_C_D_PL_Ledger = "TBNL-C-D-PL-Ledger", m2.TBNL_C_DT_PL_Ledger = "TBNL-C-DT-PL-Ledger", m2.TBNL_C_ND_PL_Ledger = "TBNL-C-ND-PL-Ledger", m2.TBNL_C_D_NPL_Ledger = "TBNL-C-D-NPL-Ledger", m2.TBNL_C_DT_NPL_Ledger = "TBNL-C-DT-NPL-Ledger", m2.TBNL_C_DTSA_PL_Ledger = "TBNL-C-DTSA-PL-Ledger", m2.TBNL_C_DTSA_NPL_Ledger = "TBNL-C-DTSA-NPL-Ledger", m2.TBNL_C_ND_NPL_Ledger = "TBNL-C-ND-NPL-Ledger", m2.TBNL_NC_D_PL_Legal = "TBNL-NC-D-PL-Legal", m2.TBNL_NC_DT_PL_Legal = "TBNL-NC-DT-PL-Legal", m2.TBNL_NC_ND_PL_Legal = "TBNL-NC-ND-PL-Legal", m2.TBNL_NC_D_NPL_Legal = "TBNL-NC-D-NPL-Legal", m2.TBNL_NC_DT_NPL_Legal = "TBNL-NC-DT-NPL-Legal", m2.TBNL_NC_DTSA_PL_Legal = "TBNL-NC-DTSA-PL-Legal", m2.TBNL_NC_DTSA_NPL_Legal = "TBNL-NC-DTSA-NPL-Legal", m2.TBNL_NC_ND_NPL_Legal = "TBNL-NC-ND-NPL-Legal", m2.TBNL_NC_D_PL_Ledger = "TBNL-NC-D-PL-Ledger", m2.TBNL_NC_DT_PL_Ledger = "TBNL-NC-DT-PL-Ledger", m2.TBNL_NC_ND_PL_Ledger = "TBNL-NC-ND-PL-Ledger", m2.TBNL_NC_D_NPL_Ledger = "TBNL-NC-D-NPL-Ledger", m2.TBNL_NC_DT_NPL_Ledger = "TBNL-NC-DT-NPL-Ledger", m2.TBNL_NC_DTSA_PL_Ledger = "TBNL-NC-DTSA-PL-Ledger", m2.TBNL_NC_DTSA_NPL_Ledger = "TBNL-NC-DTSA-NPL-Ledger", m2.TBNL_NC_ND_NPL_Ledger = "TBNL-NC-ND-NPL-Ledger", m2))(gt || {});
var j = z.nativeEnum(gt);
function je(e) {
  return z.object({ item: i, attributes: G.array().min(1).describe("A bag of attributes that can be used to store any kind of metadata that is not currently supported by the standard.").optional() }).extend(e);
}
var Tt = ((y) => (y.MUSIC = "MUSIC", y.PODCAST = "PODCAST", y.AUDIOBOOK = "AUDIOBOOK", y.VOICE_NOTE = "VOICE_NOTE", y.SOUND = "SOUND", y.OTHER = "OTHER", y))(Tt || {});
var $e = ((w) => (w.WAV = "audio/wav", w.WAV_VND = "audio/vnd.wave", w.MP3 = "audio/mpeg", w.OGG_AUDIO = "audio/ogg", w.MP4_AUDIO = "audio/mp4", w.AAC = "audio/aac", w.WEBM_AUDIO = "audio/webm", w.FLAC = "audio/flac", w))($e || {});
var pe = je({ type: z.nativeEnum($e, { description: "The mime type of the audio file." }), cover: i.optional(), duration: z.number({ description: "How long the the audio is in seconds." }).positive().int().optional(), license: j.optional().describe("The license for the audio."), credits: a.describe("The credits for the audio.").optional(), artist: a.describe("The name of the artist.").optional(), genre: a.describe("The genre of the audio").optional(), recordLabel: a.describe("The record label for the audio.").optional(), kind: z.nativeEnum(Tt, { description: "The type of audio." }).optional(), lyrics: i.optional() });
var Ze = ((N) => (N.BMP = "image/bmp", N.GIF = "image/gif", N.HEIC = "image/heic", N.JPEG = "image/jpeg", N.PNG = "image/png", N.SVG_XML = "image/svg+xml", N.TIFF = "image/tiff", N.WEBP = "image/webp", N.X_MS_BMP = "image/x-ms-bmp", N))(Ze || {});
var de = je({ type: z.nativeEnum(Ze, { description: "The mime type of the image" }), altTag: a.describe("The alt tag for accessibility").optional(), license: j.optional().describe("The license for the image") });
var Ke = ((C3) => (C3.GLTF = "model/gltf+json", C3.GLTF_BINARY = "model/gltf-binary", C3.M4V = "video/x-m4v", C3.MOV = "video/mov", C3.MP4 = "video/mp4", C3.MPEG = "video/mpeg", C3.OGG = "video/ogg", C3.OGV = "video/ogv", C3.QUICKTIME = "video/quicktime", C3.WEBM = "video/webm", C3))(Ke || {});
var ue = je({ type: z.nativeEnum(Ke, { description: "The mime type of the video" }), altTag: a.describe("The alt tag for accessibility").optional(), cover: i.optional(), duration: z.number({ description: "How long the the video is in seconds" }).positive().int().optional(), license: j.optional().describe("The license for the video") });
var St = z.object({ type: z.string() });
function Aa(e) {
  return St.safeParse(e).success;
}
function ga(e) {
  if (!Aa(e)) return St;
  switch (e.type) {
...
var f = z.discriminatedUnion("type", [pe, de, ue]).catch((e) => e.input).superRefine((e, t) => {
  let r = ga(e);
  if (!r) return t.addIssue({ code: z.ZodIssueCode.invalid_union_discriminator, options: [...new Set([Object.values($e), Object.values(Ze), Object.values(Ke)].flat())], message: "Invalid discriminator value. Expected one of `MediaAudioMimeType`, `MediaImageMimeType`, `MediaVideoMimeType` values." }), z.NEVER;
  let o = r.safeParse(e);
  if (!o.success) for (let S of o.error.issues) t.addIssue(S);
  return z.NEVER;
});
var Sa = ["Africa/Abidjan", "Africa/Accra", "Africa/Addis_Ababa", "Africa/Algiers", "Africa/Asmera", "Africa/Bamako", "Africa/Bangui", "Africa/Banjul", "Africa/Bissau", "Africa/Blantyre", "Africa/Brazzaville", "Africa/Bujumbura", "Africa/Cairo", "Africa/Casablanca", "Africa/Ceuta", "Africa/Conakry", "Africa/Dakar", "Africa/Dar_es_Salaam", "Africa/Djibouti", "Africa/Douala", "Africa/El_Aaiun", "Africa/Freetown", "Africa/Gaborone", "Africa/Harare", "Africa/Johannesburg", "Africa/Juba", "Africa/Kampala", "Africa/Khartoum", "Africa/Kigali", "Africa/Kinshasa", "Africa/Lagos", "Africa/Libreville", "Africa/Lome", "Africa/Luanda", "Africa/Lubumbashi", "Africa/Lusaka", "Africa/Malabo", "Africa/Maputo", "Africa/Maseru", "Africa/Mbabane", "Africa/Mogadishu", "Africa/Monrovia", "Africa/Nairobi", "Africa/Ndjamena", "Africa/Niamey", "Africa/Nouakchott", "Africa/Ouagadougou", "Africa/Porto-Novo", "Africa/Sao_Tome", "Africa/Tripoli", "Africa/Tunis", "Africa/Windhoek", "America/Adak", "America/Anchorage", "America/Anguilla", "America/Antigua", "America/Araguaina", "America/Argentina/La_Rioja", "America/Argentina/Rio_Gallegos", "America/Argentina/Salta", "America/Argentina/San_Juan", "America/Argentina/San_Luis", "America/Argentina/Tucuman", "America/Argentina/Ushuaia", "America/Aruba", "America/Asuncion", "America/Bahia", "America/Bahia_Banderas", "America/Barbados", "America/Belem", "America/Belize", "America/Blanc-Sablon", "America/Boa_Vista", "America/Bogota", "America/Boise", "America/Buenos_Aires", "America/Cambridge_Bay", "America/Campo_Grande", "America/Cancun", "America/Caracas", "America/Catamarca", "America/Cayenne", "America/Cayman", "America/Chicago", "America/Chihuahua", "America/Ciudad_Juarez", "America/Coral_Harbour", "America/Cordoba", "America/Costa_Rica", "America/Creston", "America/Cuiaba", "America/Curacao", "America/Danmarkshavn", "America/Dawson", "America/Dawson_Creek", "America/Denver", "America/Detroit", "America/Dominica", "America/Edmonton", "America/Eirunepe", "America/El_Salvador", "America/Fort_Nelson", "America/Fortaleza", "America/Glace_Bay", "America/Godthab", "America/Goose_Bay", "America/Grand_Turk", "America/Grenada", "America/Guadeloupe", "America/Guatemala", "America/Guayaquil", "America/Guyana", "America/Halifax", "America/Havana", "America/Hermosillo", "America/Indiana/Knox", "America/Indiana/Marengo", "America/Indiana/Petersburg", "America/Indiana/Tell_City", "America/Indiana/Vevay", "America/Indiana/Vincennes", "America/Indiana/Winamac", "America/Indianapolis", "America/Inuvik", "America/Iqaluit", "America/Jamaica", "America/Jujuy", "America/Juneau", "America/Kentucky/Monticello", "America/Kralendijk", "America/La_Paz", "America/Lima", "America/Los_Angeles", "America/Louisville", "America/Lower_Princes", "America/Maceio", "America/Managua", "America/Manaus", "America/Marigot", "America/Martinique", "America/Matamoros", "America/Mazatlan", "America/Mendoza", "America/Menominee", "America/Merida", "America/Metlakatla", "America/Mexico_City", "America/Miquelon", "America/Moncton", "America/Monterrey", "America/Montevideo", "America/Montserrat", "America/Nassau", "America/New_York", "America/Nipigon", "America/Nome", "America/Noronha", "America/North_Dakota/Beulah", "America/North_Dakota/Center", "America/North_Dakota/New_Salem", "America/Ojinaga", "America/Panama", "America/Pangnirtung", "America/Paramaribo", "America/Phoenix", "America/Port-au-Prince", "America/Port_of_Spain", "America/Porto_Velho", "America/Puerto_Rico", "America/Punta_Arenas", "America/Rainy_River", "America/Rankin_Inlet", "America/Recife", "America/Regina", "America/Resolute", "America/Rio_Branco", "America/Santa_Isabel", "America/Santarem", "America/Santiago", "America/Santo_Domingo", "America/Sao_Paulo", "America/Scoresbysund", "America/Sitka", "America/St_Barthelemy", "America/St_Johns", "America/St_Kitts", "America/St_Lucia", "America/St_Thomas", "America/St_Vincent", "America/Swift_Current", "America/Tegucigalpa", "America/Thule", "America/Thunder_Bay", "America/Tijuana", "America/Toronto", "America/Tortola", "America/Vancouver", "America/Whitehorse", "America/Winnipeg", "America/Yakutat", "America/Yellowknife", "Antarctica/Casey", "Antarctica/Davis", "Antarctica/DumontDUrville", "Antarctica/Macquarie", "Antarctica/Mawson", "Antarctica/McMurdo", "Antarctica/Palmer", "Antarctica/Rothera", "Antarctica/Syowa", "Antarctica/Troll", "Antarctica/Vostok", "Arctic/Longyearbyen", "Asia/Aden", "Asia/Almaty", "Asia/Amman", "Asia/Anadyr", "Asia/Aqtau", "Asia/Aqtobe", "Asia/Ashgabat", "Asia/Atyrau", "Asia/Baghdad", "Asia/Bahrain", "Asia/Baku", "Asia/Bangkok", "Asia/Barnaul", "Asia/Beirut", "Asia/Bishkek", "Asia/Brunei", "Asia/Calcutta", "Asia/Chita", "Asia/Choibalsan", "Asia/Colombo", "Asia/Damascus", "Asia/Dhaka", "Asia/Dili", "Asia/Dubai", "Asia/Dushanbe", "Asia/Famagusta", "Asia/Gaza", "Asia/Hebron", "Asia/Hong_Kong", "Asia/Hovd", "Asia/Irkutsk", "Asia/Jakarta", "Asia/Jayapura", "Asia/Jerusalem", "Asia/Kabul", "Asia/Kamchatka", "Asia/Karachi", "Asia/Katmandu", "Asia/Khandyga", "Asia/Krasnoyarsk", "Asia/Kuala_Lumpur", "Asia/Kuching", "Asia/Kuwait", "Asia/Macau", "Asia/Magadan", "Asia/Makassar", "Asia/Manila", "Asia/Muscat", "Asia/Nicosia", "Asia/Novokuznetsk", "Asia/Novosibirsk", "Asia/Omsk", "Asia/Oral", "Asia/Phnom_Penh", "Asia/Pontianak", "Asia/Pyongyang", "Asia/Qatar", "Asia/Qostanay", "Asia/Qyzylorda", "Asia/Rangoon", "Asia/Riyadh", "Asia/Saigon", "Asia/Sakhalin", "Asia/Samarkand", "Asia/Seoul", "Asia/Shanghai", "Asia/Singapore", "Asia/Srednekolymsk", "Asia/Taipei", "Asia/Tashkent", "Asia/Tbilisi", "Asia/Tehran", "Asia/Thimphu", "Asia/Tokyo", "Asia/Tomsk", "Asia/Ulaanbaatar", "Asia/Urumqi", "Asia/Ust-Nera", "Asia/Vientiane", "Asia/Vladivostok", "Asia/Yakutsk", "Asia/Yekaterinburg", "Asia/Yerevan", "Atlantic/Azores", "Atlantic/Bermuda", "Atlantic/Canary", "Atlantic/Cape_Verde", "Atlantic/Faeroe", "Atlantic/Madeira", "Atlantic/Reykjavik", "Atlantic/South_Georgia", "Atlantic/St_Helena", "Atlantic/Stanley", "Australia/Adelaide", "Australia/Brisbane", "Australia/Broken_Hill", "Australia/Currie", "Australia/Darwin", "Australia/Eucla", "Australia/Hobart", "Australia/Lindeman", "Australia/Lord_Howe", "Australia/Melbourne", "Australia/Perth", "Australia/Sydney", "Europe/Amsterdam", "Europe/Andorra", "Europe/Astrakhan", "Europe/Athens", "Europe/Belgrade", "Europe/Berlin", "Europe/Bratislava", "Europe/Brussels", "Europe/Bucharest", "Europe/Budapest", "Europe/Busingen", "Europe/Chisinau", "Europe/Copenhagen", "Europe/Dublin", "Europe/Gibraltar", "Europe/Guernsey", "Europe/Helsinki", "Europe/Isle_of_Man", "Europe/Istanbul", "Europe/Jersey", "Europe/Kaliningrad", "Europe/Kiev", "Europe/Kirov", "Europe/Lisbon", "Europe/Ljubljana", "Europe/London", "Europe/Luxembourg", "Europe/Madrid", "Europe/Malta", "Europe/Mariehamn", "Europe/Minsk", "Europe/Monaco", "Europe/Moscow", "Europe/Oslo", "Europe/Paris", "Europe/Podgorica", "Europe/Prague", "Europe/Riga", "Europe/Rome", "Europe/Samara", "Europe/San_Marino", "Europe/Sarajevo", "Europe/Saratov", "Europe/Simferopol", "Europe/Skopje", "Europe/Sofia", "Europe/Stockholm", "Europe/Tallinn", "Europe/Tirane", "Europe/Ulyanovsk", "Europe/Uzhgorod", "Europe/Vaduz", "Europe/Vatican", "Europe/Vienna", "Europe/Vilnius", "Europe/Volgograd", "Europe/Warsaw", "Europe/Zagreb", "Europe/Zaporozhye", "Europe/Zurich", "Indian/Antananarivo", "Indian/Chagos", "Indian/Christmas", "Indian/Cocos", "Indian/Comoro", "Indian/Kerguelen", "Indian/Mahe", "Indian/Maldives", "Indian/Mauritius", "Indian/Mayotte", "Indian/Reunion", "Pacific/Apia", "Pacific/Auckland", "Pacific/Bougainville", "Pacific/Chatham", "Pacific/Easter", "Pacific/Efate", "Pacific/Enderbury", "Pacific/Fakaofo", "Pacific/Fiji", "Pacific/Funafuti", "Pacific/Galapagos", "Pacific/Gambier", "Pacific/Guadalcanal", "Pacific/Guam", "Pacific/Honolulu", "Pacific/Johnston", "Pacific/Kiritimati", "Pacific/Kosrae", "Pacific/Kwajalein", "Pacific/Majuro", "Pacific/Marquesas", "Pacific/Midway", "Pacific/Nauru", "Pacific/Niue", "Pacific/Norfolk", "Pacific/Noumea", "Pacific/Pago_Pago", "Pacific/Palau", "Pacific/Pitcairn", "Pacific/Ponape", "Pacific/Port_Moresby", "Pacific/Rarotonga", "Pacific/Saipan", "Pacific/Tahiti", "Pacific/Tarawa", "Pacific/Tongatapu", "Pacific/Truk", "Pacific/Wake", "Pacific/Wallis"];
var Mt = z.enum(Sa);
var Dt = ((o) => (o.NSFW = "NSFW", o.SENSITIVE = "SENSITIVE", o.SPOILER = "SPOILER", o))(Dt || {});
var Ma = a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure.");
var Da = z.nativeEnum(Dt, { description: "Specify a content warning." });
function u(e) {
  return z.object({ id: Ma, attributes: G.array().min(1).max(20).optional().describe("A bag of attributes that can be used to store any kind of metadata that is not currently supported by the standard. Over time, common attributes will be added to the standard and their usage as arbitrary attributes will be discouraged."), locale: et, tags: z.set(ze).max(20).catch((t) => t.input).superRefine((t, r) => {
    let o = z.array(ze).max(20).safeParse(t);
    if (o.success) {
      let S = [...new Set(o.data)];
      return o.data.length > S.length && r.addIssue({ code: z.ZodIssueCode.custom, fatal: true, message: `Duplicate tags are not allowed: ${o.data.join(", ")}` }), z.NEVER;
    }
    for (let S of o.error.issues) r.addIssue(S);
  }).transform((t) => [...t]).optional().describe("An arbitrary list of tags."), contentWarning: Da.optional() }).extend(e);
}
function l(e) {
  return At({ signature: M.optional(), ...e });
}
function h(...e) {
  let t = "The main focus of the post.";
  if (e.length > 1) {
    let r = e.map((o) => z.literal(o));
    return z.union(r, { description: t });
  }
  return z.literal(e[0], { description: t });
}
var He = ((D) => (D.VIDEO = "VIDEO", D.IMAGE = "IMAGE", D.ARTICLE = "ARTICLE", D.TEXT_ONLY = "TEXT_ONLY", D.AUDIO = "AUDIO", D.LINK = "LINK", D.EMBED = "EMBED", D.CHECKING_IN = "CHECKING_IN", D.EVENT = "EVENT", D.MINT = "MINT", D.TRANSACTION = "TRANSACTION", D.LIVESTREAM = "LIVESTREAM", D.SHORT_VIDEO = "SHORT_VIDEO", D.THREE_D = "3D", D.STORY = "STORY", D.SPACE = "SPACE", D))(He || {});
z.nativeEnum(He);
var E = `${g}/posts`;
var s = ((d) => (d[d.THREE_D_LATEST = `${E}/3d/3.0.0.json`] = "THREE_D_LATEST", d[d.ARTICLE_LATEST = `${E}/article/3.0.0.json`] = "ARTICLE_LATEST", d[d.AUDIO_LATEST = `${E}/audio/3.0.0.json`] = "AUDIO_LATEST", d[d.CHECKING_IN_LATEST = `${E}/checking-in/3.0.0.json`] = "CHECKING_IN_LATEST", d[d.EMBED_LATEST = `${E}/embed/3.0.0.json`] = "EMBED_LATEST", d[d.EVENT_LATEST = `${E}/event/3.0.0.json`] = "EVENT_LATEST", d[d.IMAGE_LATEST = `${E}/image/3.0.0.json`] = "IMAGE_LATEST", d[d.LINK_LATEST = `${E}/link/3.0.0.json`] = "LINK_LATEST", d[d.LIVESTREAM_LATEST = `${E}/livestream/3.0.0.json`] = "LIVESTREAM_LATEST", d[d.MINT_LATEST = `${E}/mint/3.0.0.json`] = "MINT_LATEST", d[d.SPACE_LATEST = `${E}/space/3.0.0.json`] = "SPACE_LATEST", d[d.STORY_LATEST = `${E}/story/3.0.0.json`] = "STORY_LATEST", d[d.TRANSACTION_LATEST = `${E}/transaction/3.0.0.json`] = "TRANSACTION_LATEST", d[d.TEXT_ONLY_LATEST = `${E}/text-only/3.0.0.json`] = "TEXT_ONLY_LATEST", d[d.VIDEO_LATEST = `${E}/video/3.0.0.json`] = "VIDEO_LATEST", d))(s || {});
var bt = ((S) => (S.GLTF = "gLTF/GLB", S.FBX = "FBX", S.VRM = "VRM", S.OBJ = "OBJ", S))(bt || {});
var Pa = z.object({ uri: i.describe("The URI of the 3D asset zip file."), zipPath: a.optional().describe("Path in extracted zip. Relative. 3D start point, MUST be 3D file type."), playerUrl: i.describe("The URL of the recommended web based 3D player to use to view the 3D asset."), format: z.nativeEnum(bt).describe("The 3D format of the asset."), license: j.optional().describe("The license regulating the use of the 3D asset.") });
var Ea = u({ mainContentFocus: h("3D"), assets: Pa.array().min(1).describe("The 3D items for the post"), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var le = l({ $schema: z.literal(s.THREE_D_LATEST), lens: Ea });
var Ia = u({ mainContentFocus: h("ARTICLE"), content: n, title: a.describe("The optional article title.").optional(), attachments: f.array().min(1).optional().describe("Any attachment you want to include with it.") });
var he = l({ $schema: z.literal(s.ARTICLE_LATEST), lens: Ia });
var Ra = u({ mainContentFocus: h("AUDIO"), audio: pe, title: a.describe("The optional audio title.").optional(), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var fe = l({ $schema: z.literal(s.AUDIO_LATEST), lens: Ra });
var Na = u({ mainContentFocus: h("CHECKING_IN"), location: a.describe("Where you checking in from (free form text)."), position: H.describe("The optional geographic position of the location.").optional(), address: ne.optional().describe("The optional address of the location."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var ye = l({ $schema: z.literal(s.CHECKING_IN_LATEST), lens: Na });
var ka = u({ mainContentFocus: h("EMBED"), embed: i.describe("The embed URL."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Ae = l({ $schema: z.literal(s.EMBED_LATEST), lens: ka });
var va = z.object({ timezoneId: Mt.describe("Indicates a reference timezone for the event start and end times. If physical event, you could use the timezone of the event location. If virtual event, the timezone of the event organizer."), timezoneOffset: z.number().describe("Indicates the reference timezone offset with respect to UTC timezone a the time of event creation. The difference in minutes between the reference timezone time and UTC time (e.g. UTC+2 would be -120, UTC-5 would be 300, UTC would be 0).") });
var Oa = u({ title: a.describe("The title of the event.").optional(), mainContentFocus: h("EVENT"), location: z.union([i.describe("A virtual location."), a.describe("The event location (free form text).")]).describe("The location of the event."), position: H.describe("The geographic position of the event.").optional(), address: ne.optional().describe("The address of the event."), startsAt: U.describe("The event start time (ISO 8601 `YYYY-MM-DDTHH:mm:ss.sssZ`)."), endsAt: U.describe("The event end time (ISO 8601 `YYYY-MM-DDTHH:mm:ss.sssZ`)."), schedulingAdjustments: va.optional().describe("Captures extra criteria to recompute correctly future start and end times.See: https://www.w3.org/International/wiki/WorkingWithTimeZones#Working_with_Future_and_Recurring_Events"), links: i.array().min(1).optional().describe("The links you want to include with it."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Te = l({ $schema: z.literal(s.EVENT_LATEST), lens: Oa });
var Ua = u({ mainContentFocus: h("IMAGE"), image: de, title: a.describe("The optional image title.").optional(), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Se = l({ $schema: z.literal(s.IMAGE_LATEST), lens: Ua });
var za = u({ mainContentFocus: h("LINK"), sharingLink: i.describe("The sharing link url."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Me = l({ $schema: z.literal(s.LINK_LATEST), lens: za });
var Va = u({ mainContentFocus: h("LIVESTREAM"), title: a.optional().describe("The livestream title."), startsAt: U.describe("The stream start time (ISO 8601 `YYYY-MM-DDTHH:mm:ss.sssZ`)."), endsAt: U.describe("The optional stream end time (ISO 8601 `YYYY-MM-DDTHH:mm:ss.sssZ`)").optional(), playbackUrl: i.describe("Some livestream platforms have the playback url as a separate url. If not your case make sure `liveUrl` and `playbackUrl` are the same."), liveUrl: i.describe("Some livestream platforms have the live url as a separate url. If not your case make sure `liveUrl` and `playbackUrl` are the same."), checkLiveAPI: i.describe("The data cannot be changed so you can put in an API endpoint to know if it is still live or not for clients to be able to check.").optional(), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var De = l({ $schema: z.literal(s.LIVESTREAM_LATEST), lens: Va });
var ja = u({ mainContentFocus: h("MINT"), mintLink: i.describe("The mint item it can be a URL of the known provider like opensea https://opensea.io/assets/ethereum/0xfaa2471e93bd1cee3b0ab381c242ada8e1d1a759/299 or https://zora.co/collect/0x9d90669665607f08005cae4a7098143f554c59ef/39626. The Lens API has an allow list of providers and if the domain does not match it will mark it as failed metadata"), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var be = l({ $schema: z.literal(s.MINT_LATEST), lens: ja });
var Za = u({ mainContentFocus: h("SPACE"), title: a.describe("The space title."), link: i.describe("The space join link."), startsAt: U.describe("The space start time (ISO 8601 `YYYY-MM-DDTHH:mm:ss.sssZ`)."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Pe = l({ $schema: z.literal(s.SPACE_LATEST), lens: Za });
var Ha = u({ mainContentFocus: h("STORY"), asset: f.describe("The story asset."), content: n.describe("Optional markdown content.").optional() });
var Ee = l({ $schema: z.literal(s.STORY_LATEST), lens: Ha });
var Ya = u({ mainContentFocus: h("TEXT_ONLY"), content: n });
var Le = l({ $schema: z.literal(s.TEXT_ONLY_LATEST), lens: Ya });
var Et = ((o) => (o.ERC721 = "ERC721", o.ERC20 = "ERC20", o.OTHER = "OTHER", o))(Et || {});
var qa = u({ mainContentFocus: h("TRANSACTION"), txHash: a.describe("The transaction hash."), type: z.nativeEnum(Et).describe("The type of transaction."), chainId: it.describe("The Chain Id."), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var Ie = l({ $schema: z.literal(s.TRANSACTION_LATEST), lens: qa });
var Xa = u({ mainContentFocus: h("SHORT_VIDEO", "VIDEO"), video: ue, title: a.describe("The optional video title.").optional(), content: n.describe("Optional markdown content.").optional(), attachments: f.array().min(1).optional().describe("The other attachments you want to include with it.") });
var te = l({ $schema: z.literal(s.VIDEO_LATEST), lens: Xa });
z.discriminatedUnion("$schema", [he, fe, ye, Ae, Te, Se, Me, De, be, Pe, Le, Ee, Ie, le, te]);
var P = "en";
function Ws({ nft: e, locale: t = P, id: r = v4_default(), ...o }) {
  return c(Le.safeParse({ $schema: s.TEXT_ONLY_LATEST, ...e, lens: { id: r, locale: t, mainContentFocus: "TEXT_ONLY", ...o } }));
}
function R(e) {
  return z.object({ signature: M.optional(), ...e });
}
var T = ((y) => (y[y.FEED_LATEST = `${g}/rules/feed/1.0.0.json`] = "FEED_LATEST", y[y.GRAPH_LATEST = `${g}/rules/graph/1.0.0.json`] = "GRAPH_LATEST", y[y.GROUP_LATEST = `${g}/rules/group/1.0.0.json`] = "GROUP_LATEST", y[y.NAMESPACE_LATEST = `${g}/rules/namespace/1.0.0.json`] = "NAMESPACE_LATEST", y[y.POST_LATEST = `${g}/rules/post/1.0.0.json`] = "POST_LATEST", y[y.FOLLOW_LATEST = `${g}/rules/follow/1.0.0.json`] = "FOLLOW_LATEST", y))(T || {});
var tr = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processCreatePostParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processCreatePost` function."), processEditPostParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processEditPost` function."), processRemovePostParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processRemovePost` function."), processPostRuleChangesParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processPostRuleChanges` function.") });
var xe = R({ $schema: z.literal(T.FEED_LATEST), lens: tr });
var ar = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processFollowParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processFollow` function.") });
var Re = R({ $schema: z.literal(T.FOLLOW_LATEST), lens: ar });
var rr = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processFollowParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processFollow` function."), processUnfollowParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processUnfollow` function."), processFollowRuleChangesParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processFollowRuleChanges` function.") });
var Ce = R({ $schema: z.literal(T.GRAPH_LATEST), lens: rr });
var or = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processAdditionParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processAddition` function."), processRemovalParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processRemoval` function."), processJoiningParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processJoining` function."), processLeavingParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processLeaving` function.") });
var Ne = R({ $schema: z.literal(T.GROUP_LATEST), lens: or });
var ir = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processCreationParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processCreation` function."), processRemovalParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processRemoval` function."), processAssigningParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processAssigning` function."), processUnassigningParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processUnassigning` function.") });
var _e = R({ $schema: z.literal(T.NAMESPACE_LATEST), lens: ir });
var nr = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("A short name for the Rule."), description: n.describe("Markdown formatted description of the Rule."), authors: z.array(z.string().email("Authors list should only contain valid emails")).min(1, "You must supply at least one author").describe("List of authors email addresses."), source: i.describe("The link to the Rule source code. Typically a GitHub repository."), configureParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `configure` function."), processCreatePostParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processCreatePost` function."), processEditPostParams: z.array(p).describe("A list of `ContractKeyValuePairDescriptor` that describes the `ruleParams` argument of the `processEditPost` function.") });
var ke = R({ $schema: z.literal(T.POST_LATEST), lens: nr });
var ae = ((t) => (t[t.LATEST = `${g}/sponsorship/1.0.0.json`] = "LATEST", t))(ae || {});
var sr = z.object({ id: a.describe("A unique identifier that in storages like IPFS ensures the uniqueness of the metadata URI. Use a UUID if unsure."), name: a.describe("The name of the Sponsorship."), description: a.optional().describe("An optional description of the Username collection.") });
z.object({ $schema: z.literal(ae.LATEST), lens: sr, signature: M.optional() });
z.discriminatedUnion("$schema", [xe, Re, Ce, Ne, _e, ke]);
...
function C(n3 = false) {
  ...
  return !("NO_COLOR" in i2 || g2.includes("--no-color")) && ("FORCE_COLOR" in i2 || g2.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || n3 && i2.TERM !== "dumb" || "CI" in i2) || typeof window != "undefined" && !!window.chrome;
}
function p2(n3 = false) {
  let e = C(n3), i2 = (r, t, c2, o) => {
    let l2 = "", s3 = 0;
    do
      l2 += r.substring(s3, o) + c2, s3 = o + t.length, o = r.indexOf(t, s3);
    while (~o);
    return l2 + r.substring(s3);
  }, g2 = (r, t, c2 = r) => {
    let o = (l2) => {
      let s3 = String(l2), b = s3.indexOf(t, r.length);
      return ~b ? r + i2(s3, t, c2, b) + t : r + s3 + t;
    };
...
// ../../node_modules/.pnpm/@vitest+pretty-format@3.2.0/node_modules/@vitest/pretty-format/dist/index.js
...
function requireReactIs_production_min() {
  ...
  var b = Symbol.for("react.element"), c2 = Symbol.for("react.portal"), d = Symbol.for("react.fragment"), e = Symbol.for("react.strict_mode"), f4 = Symbol.for("react.profiler"), g2 = Symbol.for("react.provider"), h4 = Symbol.for("react.context"), k = Symbol.for("react.server_context"), l2 = Symbol.for("react.forward_ref"), m2 = Symbol.for("react.suspense"), n3 = Symbol.for("react.suspense_list"), p4 = Symbol.for("react.memo"), q = Symbol.for("react.lazy"), t = Symbol.for("react.offscreen"), u2;
  ...
  reactIs_production_min.isElement = function(a4) {
    return "object" === typeof a4 && null !== a4 && a4.$$typeof === b;
  };
  ...
  reactIs_production_min.isSuspenseList = function(a4) {
    return v(a4) === n3;
  };
  reactIs_production_min.isValidElementType = function(a4) {
    return "string" === typeof a4 || "function" === typeof a4 || a4 === d || a4 === f4 || a4 === e || a4 === m2 || a4 === n3 || a4 === t || "object" === typeof a4 && null !== a4 && (a4.$$typeof === q || a4.$$typeof === p4 || a4.$$typeof === g2 || a4.$$typeof === h4 || a4.$$typeof === l2 || a4.$$typeof === u2 || void 0 !== a4.getModuleId) ? true : false;
  };
...
function inspectFunction(func, options) {
  const functionType2 = func[Symbol.toStringTag] || "Function";
  const name = func.name;
  if (!name) {
    return options.stylize(`[${functionType2}]`, "special");
  }
  return options.stylize(`[${functionType2} ${truncate(name, options.truncate - 11)}]`, "special");
}
...
// ../../node_modules/.pnpm/@vitest+utils@3.2.0/node_modules/@vitest/utils/dist/chunk-_commonjsHelpers.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.2.0/node_modules/@vitest/utils/dist/helpers.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.2.0/node_modules/@vitest/utils/dist/index.js
var jsTokens_1;
...
// ../../node_modules/.pnpm/@vitest+utils@3.2.0/node_modules/@vitest/utils/dist/diff.js
var DIFF_DELETE = -1;
var DIFF_INSERT = 1;
var DIFF_EQUAL = 0;
var Diff = class {
...
function diffStrings(a4, b, options) {
  const truncate3 = (options === null || options === void 0 ? void 0 : options.truncateThreshold) ?? false;
  const truncateThreshold = Math.max(Math.floor((options === null || options === void 0 ? void 0 : options.truncateThreshold) ?? 0), 0);
  ...
  if (truncate3) {
    ...
    const _a = aMultipleLines ? `${a4.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}
` : a4;
...
` : b;
  ...
  const truncated = aLength !== a4.length || bLength !== b.length;
  const isCommon = (aIndex2, bIndex2) => a4[aIndex2] === b[bIndex2];
  let aIndex = 0;
  let bIndex = 0;
  const diffs = [];
  const foundSubsequence = (nCommon, aCommon, bCommon) => {
...
function diffStringsUnified(a4, b, options) {
  if (a4 !== b && a4.length !== 0 && b.length !== 0) {
    const isMultiline = a4.includes("\n") || b.includes("\n");
    const [diffs, truncated] = diffStringsRaw(isMultiline ? `${a4}
` : a4, isMultiline ? `${b}
` : b, true, options);
...
function diffStringsRaw(a4, b, cleanup, options) {
  const [diffs, truncated] = diffStrings(a4, b, options);
  {
...
${bDiff}`;
  ...
  switch (aType) {
    ...
    case "boolean":
    case "number":
      return comparePrimitive(a4, b, options);
    case "map":
      return compareObjects(sortMap(a4), sortMap(b), options);
    case "set":
      return compareObjects(sortSet(a4), sortSet(b), options);
    default:
      return compareObjects(a4, b, options);
  }
}
function comparePrimitive(a4, b, options) {
...
function compareObjects(a4, b, options) {
  let difference;
  let hasThrown = false;
  try {
    const formatOptions = getFormatOptions(FORMAT_OPTIONS, options);
    difference = getObjectsDifference(a4, b, formatOptions, options);
  } catch {
    hasThrown = true;
  }
...
function getObjectsDifference(a4, b, formatOptions, options) {
...
function printReceived(object2) {
  return s2.red(replaceTrailingSpaces(stringify(object2)));
}
function printExpected(value) {
  return s2.green(replaceTrailingSpaces(stringify(value)));
}
function getCommonAndChangedSubstrings(diffs, op, hasCommonDiff2) {
  return diffs.reduce((reduced, diff2) => reduced + (diff2[0] === DIFF_EQUAL ? diff2[1] : diff2[0] === op ? hasCommonDiff2 ? s2.inverse(diff2[1]) : diff2[1] : ""), "");
}
  ...
  let fn2 = function(...args) {
    ...
    if (state2.impl)
      try {
        ...
        throw result = err3, type3 = "error", state2.results.push([type3, err3]), err3;
      }
...
// ../../node_modules/.pnpm/@vitest+spy@3.2.0/node_modules/@vitest/spy/dist/index.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.2.0/node_modules/@vitest/utils/dist/error.js
...
function getUnserializableMessage(err3) {
  if (err3 instanceof Error) {
    return `<unserializable>: ${err3.message}`;
  }
  if (typeof err3 === "string") {
    return `<unserializable>: ${err3}`;
  }
  ...
  if (Array.isArray(val)) {
    ...
    val.forEach((e, i2) => {
      try {
        ...
        clone2[i2] = getUnserializableMessage(err3);
      }
    });
    return clone2;
  } else {
    ...
    while (obj && obj !== OBJECT_PROTO) {
      Object.getOwnPropertyNames(obj).forEach((key) => {
        ...
        try {
          ...
          delete clone2[key];
          clone2[key] = getUnserializableMessage(err3);
        }
      });
...
function processError(_err, diffOptions, seen = /* @__PURE__ */ new WeakSet()) {
  ...
  const err3 = _err;
  if (err3.showDiff || err3.showDiff === void 0 && err3.expected !== void 0 && err3.actual !== void 0) {
    err3.diff = printDiffOrStringify(err3.actual, err3.expected, {
      ...diffOptions,
      ...err3.diffOptions
    });
  }
  if ("expected" in err3 && typeof err3.expected !== "string") {
    err3.expected = stringify(err3.expected, 10);
  }
  if ("actual" in err3 && typeof err3.actual !== "string") {
    err3.actual = stringify(err3.actual, 10);
  }
  try {
    if (typeof err3.message === "string") {
      err3.message = normalizeErrorMessage(err3.message);
    }
  } catch {
  }
  try {
    if (!seen.has(err3) && typeof err3.cause === "object") {
      seen.add(err3);
      err3.cause = processError(err3.cause, diffOptions, seen);
    }
  } catch {
  }
  try {
    return serializeValue(err3);
  } catch (e) {
    return serializeValue(new Error(`Failed to fully serialize error: ${e === null || e === void 0 ? void 0 : e.message}
Inner error message: ${err3 === null || err3 === void 0 ? void 0 : err3.message}`));
  }
}
...
function expectTypes(obj, types) {
  ...
  var str = types.map(function(t, index2) {
    ...
    var or2 = types.length > 1 && index2 === types.length - 1 ? "or " : "";
    return or2 + art + " " + t;
  }).join(", ");
...
function inspectFunction2(func, options) {
  ...
  return options.stylize(`[${functionType2} ${truncate2(name, options.truncate - 11)}]`, "special");
}
...
function compareByInspect(a4, b) {
  return inspect22(a4) < inspect22(b) ? -1 : 1;
}
...
function SameValueZero(a4, b) {
  return isNaN22(a4) && isNaN22(b) || a4 === b;
}
    ...
    default:
      ...
      props.forEach(function(prop) {
        ...
        try {
          ...
          if (!check_error_exports.compatibleConstructor(err3, AssertionError)) {
            throw err3;
          }
          if (firstErr === null)
            firstErr = err3;
...
function assertAbove(n3, msg) {
  if (msg)
    flag2(this, "message", msg);
  var obj = flag2(this, "object"), doLength = flag2(this, "doLength"), flagMsg = flag2(this, "message"), msgPrefix = flagMsg ? flagMsg + ": " : "", ssfi = flag2(this, "ssfi"), objType = type(obj).toLowerCase(), nType = type(n3).toLowerCase();
...
function assertKeys(keys2) {
  var obj = flag2(this, "object"), objType = type(obj), keysType = type(keys2), ssfi = flag2(this, "ssfi"), isDeep = flag2(this, "deep"), str, deepStr = "", actual, ok4 = true, flagMsg = flag2(this, "message");
  flagMsg = flagMsg ? flagMsg + ": " : "";
  ...
  if (any) {
    ok4 = expected.some(function(expectedKey) {
  ...
  if (all) {
    ok4 = expected.every(function(expectedKey) {
      return actual.some(function(actualKey) {
        return isEql(expectedKey, actualKey);
      });
    });
    if (!flag2(this, "contains")) {
      ok4 = ok4 && keys2.length == actual.length;
    }
  }
  if (len > 1) {
...
assert2.operator = function(val, operator, val2, msg) {
  ...
  var test22 = new Assertion(ok4, msg, assert2.operator, true);
  test22.assert(
...
// ../../node_modules/.pnpm/@vitest+expect@3.2.0/node_modules/@vitest/expect/dist/index.js
...
function equals(a4, b, customTesters, strictCheck) {
  customTesters = customTesters || [];
  return eq(a4, b, [], [], customTesters, strictCheck ? hasKey : hasDefinedKey);
}
function isAsymmetric(obj) {
  return !!obj && typeof obj === "object" && "asymmetricMatch" in obj && isA("Function", obj.asymmetricMatch);
}
function asymmetricMatch(a4, b) {
  ...
  if (asymmetricA) {
    return a4.asymmetricMatch(b);
  }
  if (asymmetricB) {
    return b.asymmetricMatch(a4);
  }
}
function eq(a4, b, aStack, bStack, customTesters, hasKey2) {
  let result = true;
  const asymmetricResult = asymmetricMatch(a4, b);
  if (asymmetricResult !== void 0) {
    return asymmetricResult;
  }
  const testerContext = { equals };
  for (let i2 = 0; i2 < customTesters.length; i2++) {
    const customTesterResult = customTesters[i2].call(testerContext, a4, b, customTesters);
    if (customTesterResult !== void 0) {
      return customTesterResult;
    }
  }
  if (typeof URL === "function" && a4 instanceof URL && b instanceof URL) {
    return a4.href === b.href;
  }
  if (Object.is(a4, b)) {
    return true;
  }
  ...
  const className = Object.prototype.toString.call(a4);
  ...
  switch (className) {
    ...
    case "[object Number]":
      if (typeof a4 !== typeof b) {
        return false;
      } else if (typeof a4 !== "object" && typeof b !== "object") {
        return Object.is(a4, b);
      } else {
        return Object.is(a4.valueOf(), b.valueOf());
      }
    case "[object Date]": {
      const numA = +a4;
      const numB = +b;
    ...
    case "[object RegExp]":
      return a4.source === b.source && a4.flags === b.flags;
    ...
    case "[object Temporal.Duration]":
      return a4.toString() === b.toString();
  }
  if (typeof a4 !== "object" || typeof b !== "object") {
    return false;
  }
  if (isDomNode(a4) && isDomNode(b)) {
    return a4.isEqualNode(b);
  }
  ...
  aStack.push(a4);
  bStack.push(b);
  if (className === "[object Array]" && a4.length !== b.length) {
    return false;
  }
  if (a4 instanceof Error && b instanceof Error) {
    try {
      return isErrorEqual(a4, b, aStack, bStack, customTesters, hasKey2);
    } finally {
      aStack.pop();
      bStack.pop();
    }
  ...
  while (size--) {
    key = aKeys[size];
    result = hasKey2(b, key) && eq(a4[key], b[key], aStack, bStack, customTesters, hasKey2);
    if (!result) {
      return false;
    }
  }
...
function isErrorEqual(a4, b, aStack, bStack, customTesters, hasKey2) {
  let result = Object.getPrototypeOf(a4) === Object.getPrototypeOf(b) && a4.name === b.name && a4.message === b.message;
  if (typeof b.cause !== "undefined") {
    result && (result = eq(a4.cause, b.cause, aStack, bStack, customTesters, hasKey2));
  }
  if (a4 instanceof AggregateError && b instanceof AggregateError) {
    result && (result = eq(a4.errors, b.errors, aStack, bStack, customTesters, hasKey2));
  }
  result && (result = eq({ ...a4 }, { ...b }, aStack, bStack, customTesters, hasKey2));
  return result;
}
...
function iterableEquality(a4, b, customTesters = [], aStack = [], bStack = []) {
  if (typeof a4 !== "object" || typeof b !== "object" || Array.isArray(a4) || Array.isArray(b) || !hasIterator(a4) || !hasIterator(b)) {
    return void 0;
  }
  if (a4.constructor !== b.constructor) {
    return false;
  }
  let length = aStack.length;
  while (length--) {
  ...
  function iterableEqualityWithStack(a5, b2) {
    return iterableEquality(a5, b2, [...customTesters], [...aStack], [...bStack]);
  }
  if (a4.size !== void 0) {
    if (a4.size !== b.size) {
      return false;
...
function typeEquality(a4, b) {
  if (a4 == null || b == null || a4.constructor === b.constructor) {
    return void 0;
  }
  return false;
}
function arrayBufferEquality(a4, b) {
  let dataViewA = a4;
  let dataViewB = b;
  if (!(a4 instanceof DataView && b instanceof DataView)) {
    if (!(a4 instanceof ArrayBuffer) || !(b instanceof ArrayBuffer)) {
      return void 0;
    }
    try {
...
function sparseArrayEquality(a4, b, customTesters = []) {
  if (!Array.isArray(a4) || !Array.isArray(b)) {
    return void 0;
  }
  const aKeys = Object.keys(a4);
  const bKeys = Object.keys(b);
  const filteredCustomTesters = customTesters.filter((t) => t !== sparseArrayEquality);
  return equals(a4, b, filteredCustomTesters, true) && equals(aKeys, bKeys);
}
...
function getObjectKeys(object2) {
  return [...Object.keys(object2), ...Object.getOwnPropertySymbols(object2).filter((s3) => {
    var _Object$getOwnPropert;
    return (_Object$getOwnPropert = Object.getOwnPropertyDescriptor(object2, s3)) === null || _Object$getOwnPropert === void 0 ? void 0 : _Object$getOwnPropert.enumerable;
  })];
}
...
function createAssertionMessage(util2, assertion, hasArgs) {
  ...
  const name = `${util2.flag(assertion, "_name")}(${hasArgs ? "expected" : ""})`;
...
function wrapAssertion(utils, name, fn2) {
  return function(...args) {
    ...
    try {
      ...
      test5.result.errors.push(processError(err3));
    }
  };
}
var JestChaiExpect = (chai2, utils) => {
  ...
  function def(name, fn2) {
    const addMethod2 = (n3) => {
      ...
      utils.addMethod(chai2.Assertion.prototype, n3, softWrapper);
...
(${stripped} matching ${stripped === 1 ? "property" : "properties"} omitted from actual)`;
  ...
  function equalsArgumentArray(a4, b) {
    return a4.length === b.length && a4.every((aItem, i2) => equals(aItem, b[i2], [...customTesters, iterableEquality]));
  }
  ...
  [{
    ...
    condition: (spy, times) => spy.mock.settledResults.reduce((s3, { type: type3 }) => type3 === "fulfilled" ? ++s3 : s3, 0) === times,
    action: "resolved"
  }, {
    name: ["toHaveReturnedTimes", "toReturnTimes"],
    condition: (spy, times) => spy.mock.results.reduce((s3, { type: type3 }) => type3 === "throw" ? s3 : ++s3, 0) === times,
    action: "called"
  }].forEach(({ name, condition, action }) => {
    ...
    const proxy = new Proxy(this, { get: (target, key, receiver) => {
      ...
      return (...args) => {
        ...
        const promise = obj.then((value) => {
          ...
          const _error = new AssertionError2(`promise rejected "${utils.inspect(err3)}" instead of resolving`, { showDiff: false });
          _error.cause = err3;
...
${spy.mock.calls.map((callArg, i2) => {
      let methodCall = s2.bold(`  ${ordinalOf(i2 + 1)} ${spy.getMockName()} call:
...
${results.map((callReturn, i2) => {
      let methodCall = s2.bold(`  ${ordinalOf(i2 + 1)} ${spy.getMockName()} call return:
...
// ../../node_modules/.pnpm/@vitest+runner@3.2.0/node_modules/@vitest/runner/dist/chunk-hooks.js
      ...
      cases.forEach((i2, idx) => {
        ...
        if (fnFirst) {
          if (arrayOnlyCases) {
            ...
            suite2(formatTitle(_name, items, idx), () => handler(i2), options);
          }
        } else {
          if (arrayOnlyCases) {
            suite2(formatTitle(_name, items, idx), options, () => handler(...items));
          } else {
            suite2(formatTitle(_name, items, idx), options, () => handler(i2));
          }
        }
      });
      ...
      cases.forEach((i2, idx) => {
        ...
        if (fnFirst) {
          if (arrayOnlyCases) {
            ...
            test5(formatTitle(_name, items, idx), () => handler(i2), options);
          }
        } else {
          if (arrayOnlyCases) {
            test5(formatTitle(_name, items, idx), options, () => handler(...items));
          } else {
            test5(formatTitle(_name, items, idx), options, () => handler(i2));
          }
        }
      });
      this.setContext("each", void 0);
...
function formatTemplateString(cases, args) {
  ...
  for (let i2 = 0; i2 < Math.floor(args.length / header.length); i2++) {
    ...
    for (let j2 = 0; j2 < header.length; j2++) {
      oneCase[header[j2]] = args[i2 * header.length + j2];
    }
    res.push(oneCase);
  }
  return res;
...
function encodeUint8Array(bytes) {
  ...
  for (let i2 = 0; i2 < len; i2 += 3) {
    if (len === i2 + 1) {
      const a4 = (bytes[i2] & 252) >> 2;
      const b = (bytes[i2] & 3) << 4;
      base64 += table[a4];
      base64 += table[b];
      base64 += "==";
    } else if (len === i2 + 2) {
      const a4 = (bytes[i2] & 252) >> 2;
      const b = (bytes[i2] & 3) << 4 | (bytes[i2 + 1] & 240) >> 4;
      const c2 = (bytes[i2 + 1] & 15) << 2;
      base64 += table[a4];
      base64 += table[b];
      base64 += table[c2];
      base64 += "=";
      ...
      const a4 = (bytes[i2] & 252) >> 2;
      const b = (bytes[i2] & 3) << 4 | (bytes[i2 + 1] & 240) >> 4;
      const c2 = (bytes[i2 + 1] & 15) << 2 | (bytes[i2 + 2] & 192) >> 6;
      const d = bytes[i2 + 2] & 63;
      base64 += table[a4];
      base64 += table[b];
      base64 += table[c2];
      base64 += table[d];
...
// ../../node_modules/.pnpm/vitest@3.2.0_@types+node@22.15.29_happy-dom@15.11.7_msw@2.7.0_@types+node@22.15.29_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/utils.XdZDrNZV.js
...
// ../../node_modules/.pnpm/vitest@3.2.0_@types+node@22.15.29_happy-dom@15.11.7_msw@2.7.0_@types+node@22.15.29_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
function getDefaultExportFromCjs3(x) {
  return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, "default") ? x["default"] : x;
}

// ../../node_modules/.pnpm/@vitest+snapshot@3.2.0/node_modules/@vitest/snapshot/dist/index.js
...
function sortComparator$1(a4, b) {
  return a4[0] - b[0];
}
var schemeRegex = /^[\w+.-]+:\/\//;
var urlRegex = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/;
...
function sortComparator(a4, b) {
  return a4[COLUMN] - b[COLUMN];
}
var found = false;
...
var TraceMap = class {
  constructor(map2, mapUrl) {
    ...
    this.resolvedSources = sources.map((s3) => resolve3(s3 || "", from));
...
function shouldFilter(ignoreStackEntries, file) {
  return ignoreStackEntries.some((p4) => file.match(p4));
}
...
a3.open = "";
a3.close = "";
function C2(n3 = false) {
  let e = typeof process != "undefined" ? process : void 0, i2 = (e == null ? void 0 : e.env) || {}, g2 = (e == null ? void 0 : e.argv) || [];
  return !("NO_COLOR" in i2 || g2.includes("--no-color")) && ("FORCE_COLOR" in i2 || g2.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || n3 && i2.TERM !== "dumb" || "CI" in i2) || typeof window != "undefined" && !!window.chrome;
}
function p3(n3 = false) {
  let e = C2(n3), i2 = (r, t, c2, o) => {
    let l2 = "", s3 = 0;
    do
      l2 += r.substring(s3, o) + c2, s3 = o + t.length, o = r.indexOf(t, s3);
    while (~o);
...
async function saveInlineSnapshots(environment2, snapshots) {
  ...
  await Promise.all(Array.from(files).map(async (file) => {
    ...
    const code = await environment2.readSnapshotFile(file);
    const s3 = new MagicString2(code);
    for (const snap of snaps) {
      const index2 = positionToOffset(code, snap.line, snap.column);
      replaceInlineSnap(code, s3, index2, snap.snapshot);
    }
    const transformed = s3.toString();
    if (transformed !== code) {
      await environment2.saveSnapshotFile(file, transformed);
    }
  }));
}
var startObjectRegex = /(?:toMatchInlineSnapshot|toThrowErrorMatchingInlineSnapshot)\s*\(\s*(?:\/\*[\s\S]*\*\/\s*|\/\/.*(?:[\n\r\u2028\u2029]\s*|[\t\v\f \xA0\u1680\u2000-\u200A\u202F\u205F\u3000\uFEFF]))*\{/;
function replaceObjectSnap(code, s3, index2, newSnap) {
  ...
  if (shapeEnd === callEnd) {
    s3.appendLeft(callEnd, snap);
  } else {
    s3.overwrite(shapeEnd, callEnd, snap);
  }
  return true;
}
...
function replaceInlineSnap(code, s3, currentIndex, newSnap) {
  ...
  s3.overwrite(startIndex - 1, endIndex, snapString);
  return true;
}
...
async function saveRawSnapshots(environment2, snapshots) {
  await Promise.all(snapshots.map(async (snap) => {
    if (!snap.readonly) {
      await environment2.saveSnapshotFile(snap.file, snap.snapshot);
    }
  }));
}
...
function requireNaturalCompare() {
  ...
  var naturalCompare2 = function(a4, b) {
...
async function saveSnapshotFile(environment2, snapshotData, snapshotPath) {
  ...
  const content = `${environment2.getHeader()}

${snapshots.join("\n\n")}
`;
  const oldContent = await environment2.readSnapshotFile(snapshotPath);
  const skipWriting = oldContent != null && oldContent === content;
  if (skipWriting) {
    return;
  }
  await environment2.saveSnapshotFile(snapshotPath, content);
}
...
var SnapshotState = class _SnapshotState {
  ...
  clearTest(testId) {
    this._inlineSnapshots = this._inlineSnapshots.filter((s3) => s3.testId !== testId);
    this._inlineSnapshotStacks = this._inlineSnapshotStacks.filter((s3) => s3.testId !== testId);
...
${JSON.stringify(stacks)}`);
      ...
      stack.column--;
      const snapshotsWithSameStack = this._inlineSnapshotStacks.filter((s3) => isSameStackPosition(s3, stack));
      if (snapshotsWithSameStack.length > 0) {
        this._inlineSnapshots = this._inlineSnapshots.filter((s3) => !isSameStackPosition(s3, stack));
        const differentSnapshot = snapshotsWithSameStack.find((s3) => s3.snapshot !== receivedSerialized);
  ...
  assert(options) {
    ...
    if (typeof properties === "object") {
      ...
      try {
        ...
        err3.message = errorMessage || "Snapshot mismatched";
        throw err3;
      }
    }
...
// ../../node_modules/.pnpm/vitest@3.2.0_@types+node@22.15.29_happy-dom@15.11.7_msw@2.7.0_@types+node@22.15.29_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
var RealDate = Date;
var now2 = null;
var MockDate = class _MockDate extends RealDate {
  constructor(y, m2, d, h4, M2, s3, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s3 = s3 || 0;
        ms = ms || 0;
        date = new RealDate(y, m2, d, h4, M2, s3, ms);
        break;
    }
...
// ../../node_modules/.pnpm/vitest@3.2.0_@types+node@22.15.29_happy-dom@15.11.7_msw@2.7.0_@types+node@22.15.29_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/vi.bdSIJ99Y.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
function createAssertionMessage2(util2, assertion, hasArgs) {
  const not = util2.flag(assertion, "negate") ? "not." : "";
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      if (!resolved) {
        const processor = globalThis.__vitest_worker__?.onFilterStackTrace || ((s3) => s3 || "");
        const stack = processor(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
    ...
    function compareTimers(a4, b) {
      if (a4.callAt < b.callAt) {
        return -1;
      }
      if (a4.callAt > b.callAt) {
        return 1;
      }
      if (a4.immediate && !b.immediate) {
        return -1;
      }
      if (!a4.immediate && b.immediate) {
        return 1;
      }
      if (a4.createdAt < b.createdAt) {
        return -1;
      }
      if (a4.createdAt > b.createdAt) {
        return 1;
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`
    ...
    function createClock(start, loopLimit) {
      ...
      function doTick(tickValue, isAsync2, resolve4, reject) {
      ...
      for (i2 = 0, l2 = clock.methods.length; i2 < l2; i2++) {
        ...
        if (clock.timersPromisesModuleMethods !== void 0) {
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setTimeout = (delay3, value, options = {}) => new Promise((resolve4, reject) => {
              const abort = () => {
            ...
            timersPromisesModule.setInterval = (delay3, value, options = {}) => ({
...
// ../../node_modules/.pnpm/vitest@3.2.0_@types+node@22.15.29_happy-dom@15.11.7_msw@2.7.0_@types+node@22.15.29_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/index.js
...
__export(src_exports, {
  ...
  MetadataIndexingError: () => MetadataIndexingError,
  OperationType: () => OperationType,
  PublicClient: () => PublicClient,
  SigningError: () => SigningError,
  TransactionError: () => TransactionError,
  TransactionIndexingError: () => TransactionIndexingError,
  UnauthenticatedError: () => UnauthenticatedError,
  UnexpectedError: () => UnexpectedError,
  ValidationError: () => ValidationError,
  authenticatedUser: () => authenticatedUser,
  cache: () => cache,
  hasExtensionCode: () => hasExtensionCode,
  isTransactionRequest: () => isTransactionRequest
});
__reExport(src_exports, env_star__namespace);
__reExport(src_exports, graphql_star__namespace);
__reExport(src_exports, types_star__namespace);
...
var UnauthenticatedError = class _UnauthenticatedError extends types_star.ResultAwareError {
  name = "UnauthenticatedError";
  static fromCombinedError(error) {
    return new _UnauthenticatedError(error.message, { cause: error });
  }
};
var UnexpectedError = class extends types_star.ResultAwareError {
  name = "UnexpectedError";
};
var AuthenticationError = class extends types_star.ResultAwareError {
  name = "AuthenticationError";
};
var SigningError = class extends types_star.ResultAwareError {
  name = "SigningError";
};
var TransactionError = class extends types_star.ResultAwareError {
  name = "TransactionError";
};
var TransactionIndexingError = class extends types_star.ResultAwareError {
  name = "TransactionIndexingError";
};
var MetadataIndexingError = class extends types_star.ResultAwareError {
  name = "MetadataIndexingError";
};
var ValidationError = class _ValidationError extends types_star.ResultAwareError {
  constructor(cause) {
    super(cause.reason);
    this.cause = cause;
  }
...
function decodeIdToken(token) {
  try {
    return types_star.ok(jwtDecode.jwtDecode(token));
  } catch (cause) {
    return types_star.err(UnexpectedError.from(cause));
  }
}
...
function authenticatedUser(claims) {
  switch (claims[ROLE_CLAIM]) {
    case graphql_star.Role.AccountManager:
      return types_star.ok({
        address: claims.act?.sub ?? types_star.never("Account Manager must have an Actor Claim"),
        app: claims.aud,
        authenticationId: claims.sid,
        role: graphql_star.Role.AccountManager,
        signer: claims.sub,
        sponsored: claims[SPONSORED_CLAIM]
      });
    case graphql_star.Role.AccountOwner:
      return types_star.ok({
        address: claims.act?.sub ?? types_star.never("Account Owner must have an Actor Claim"),
        app: claims.aud,
        authenticationId: claims.sid,
        role: graphql_star.Role.AccountOwner,
        signer: claims.sub,
        sponsored: claims[SPONSORED_CLAIM]
      });
    case graphql_star.Role.OnboardingUser:
    case graphql_star.Role.Builder:
      return types_star.ok({
        address: claims.sub,
        app: claims.aud,
        authenticationId: claims.sid,
...
var cache = /* @__PURE__ */ exchangeGraphcache.cacheExchange({
  schema: introspectedSchema__default.default,
  keys: {
    // Entities with address field as key
    Account: (data) => data.address,
    App: (data) => data.address,
    Feed: (data) => data.address,
    Graph: (data) => data.address,
    Group: (data) => data.address,
    UsernameNamespace: (data) => data.address,
    Sponsorship: (data) => data.address,
    SimpleCollectActionContract: (data) => data.address,
    TippingPostActionContract: (data) => data.address,
    UnknownPostActionContract: (data) => data.address,
    SimpleCollectAction: (data) => data.address,
    TippingAccountAction: (data) => data.address,
    UnknownAccountAction: (data) => data.address,
    UnknownPostAction: (data) => data.address,
    // Entities with other fields as key
    AuthenticatedSession: (data) => data.authenticationId,
  ...
  updates: {
    Mutation: {
      follow: (result, args, cache2) => {
        if (result.value.__typename === "FollowResponse") {
          cache2.writeFragment(
            core.gql`
...
function revokeAuthentication(client, request) {
  return client.mutation(graphql_star.RevokeAuthenticationMutation, { request });
}
function switchAccount(client, request) {
  return client.mutation(graphql_star.SwitchAccountMutation, { request });
}
...
function transactionStatus(client, request) {
  return client.query(graphql_star.TransactionStatusQuery, { request }, "network-only");
}
var BatchQueryBuilder = class {
  // biome-ignore lint/suspicious/noExplicitAny: intentional due to the etherogenous nature of the queries
  queries = [];
  addQuery = (document, variables) => {
    types_star.invariant(
      this.queries.length < 10,
      "Batch queries supports a maximum of 10 queries"
    );
    const alias = `value_${this.queries.length}`;
    const deferred = new types_star.Deferred();
    this.queries.push({ alias, document, variables, deferred });
    return types_star.ResultAsync.fromPromise(deferred.promise, (err3) => {
      if (UnexpectedError.is(err3)) {
        return err3;
      }
  ...
  build() {
    ...
    for (const { alias, document, variables } of this.queries) {
      ...
      const varMapping = /* @__PURE__ */ new Map();
      const localDefs = operation.variableDefinitions?.map((v) => {
        const newVarName = `${v.variable.name.value}_${varId++}`;
        varMapping.set(v.variable.name.value, newVarName);
        mergedVariables[newVarName] = variables[v.variable.name.value] ?? types_star.never();
        return {
          ...v,
          variable: {
            ...v.variable,
            name: { kind: graphql.Kind.NAME, value: newVarName }
          }
        };
      }) ?? [];
      variableDefinitions.push(...localDefs);
      const rewritten = graphql.visit(operation.selectionSet, {
        Variable(node) {
          const renamed = varMapping.get(node.name.value);
          if (!renamed) return node;
          return {
            ...node,
            name: { kind: graphql.Kind.NAME, value: renamed }
          };
        },
        Field(node) {
          return {
            ...node,
            alias: { kind: graphql.Kind.NAME, value: alias }
          };
        }
      });
      selections.push(...rewritten.selections);
    }
    ...
    return [mergedDocument, mergedVariables];
  }
  resolve(data) {
    for (const { alias, deferred } of this.queries) {
      if (Object.hasOwn(data, alias) && data[alias] !== void 0) {
...
function extractQueryParts(document) {
  let operation;
  const fragments = [];
  for (const definition of document.definitions) {
    switch (definition.kind) {
      case graphql.Kind.OPERATION_DEFINITION:
        types_star.invariant(
          definition.operation === graphql.OperationTypeNode.QUERY,
      ...
      case graphql.Kind.FRAGMENT_DEFINITION:
        ...
        break;
      default:
        types_star.never(`Unexpected definition kind: ${definition.kind}`);
    }
  }
  types_star.invariant(operation, "No operation definition found in the document");
...
var FragmentDeduplicator = class {
  ...
  dedupe() {
    ...
    return graphql.visit(this.document, {
      FragmentDefinition: (node) => {
  ...
  getFragment(name) {
    ...
    if (this._fragments) {
      ...
      for (const defNode of this.document.definitions) {
        if (defNode.kind === graphql.Kind.FRAGMENT_DEFINITION) {
...
var FragmentResolver = class _FragmentResolver {
  ...
  replaceFrom(document) {
    const injected = graphql.visit(document, {
      FragmentDefinition: (node) => {
...
var Logger = class _Logger {
  ...
  replaceMethods() {
    ["trace", "debug", "info", "warn", "error"].forEach(
      (methodName, index2) => {
        if (index2 >= this.level) {
          this[methodName] = () => {
          };
        } else {
          this[methodName] = (...args) => console[methodName === "debug" ? "log" : methodName](
            `[${this.name}]`,
            ...args
          );
        }
...
function takeValue({
  ...
  types_star.invariant(data, `Expected a value, got: ${error?.message}`);
  return data.value;
}
var AbstractClient = class {
  ...
  batch(cb) {
    ...
    const combined = types_star.ResultAsync.combine(cb(client));
    const [document, variables] = builder.build();
    const query = this.context.fragments.replaceFrom(document);
    return this.resultFrom(this.urql.query(query, variables)).andTee(({ data, error }) => {
      types_star.invariant(data, `Expected a value, got: ${error?.message}`);
  ...
  exchanges() {
    if (this.context.cache) {
      return [this.context.cache, core.fetchExchange];
    }
    return [core.fetchExchange];
  }
  resultFrom(source) {
    return types_star.ResultAsync.fromPromise(source.toPromise(), (err3) => {
      this.logger.error(err3);
      console.log(err3);
      return UnexpectedError.from(err3);
    }).andThen((result) => {
      if (result.error?.networkError) {
        return types_star.errAsync(UnexpectedError.from(result.error.networkError));
      }
      return types_star.okAsync(result);
    });
  }
};
var PublicClient = class _PublicClient extends AbstractClient {
   ...
   */
  challenge(request) {
    return this.mutation(graphql_star.ChallengeMutation, { request });
  }
  /**
   * Authenticate the user with the signed authentication challenge.
   */
  authenticate(request) {
    return this.mutation(graphql_star.AuthenticateMutation, { request }).andThen((result) => {
      if (result.__typename === "AuthenticationTokens") {
        return types_star.okAsync(result);
      }
      return AuthenticationError.from(result.reason).asResultAsync();
    }).andThen(
      (tokens) => this.createCredentialsStorage().set(tokens).mapErr((err3) => UnexpectedError.from(err3))
  ...
  login({
    ...
    return this.challenge(request).map(async (challenge) => ({
      challenge,
      signature: await types_star.ResultAsync.fromPromise(
        signMessage(challenge.text),
        (err3) => SigningError.from(err3)
      )
    })).andThen(({ challenge, signature }) => {
      if (signature.isErr()) {
        return types_star.errAsync(signature.error);
      }
      return this.authenticate({
        id: challenge.id,
        signature: types_star.signatureFrom(signature.value)
      });
    });
  }
  /**
  ...
  resumeSession() {
    return this.createCredentialsStorage().resume().mapErr((err3) => UnexpectedError.from(err3)).andThen((storage) => {
      ...
      return types_star.ok(new SessionClient(storage, this));
    });
  }
  /**
   ...
   */
  query(document, variables, requestPolicy = "cache-first") {
    const query = this.context.fragments.replaceFrom(document);
  ...
  createCredentialsStorage() {
    return storage.CredentialsStorage.from(
...
var SessionClient = class _SessionClient extends AbstractClient {
  ...
  getCredentials() {
    try {
      ...
      return types_star.ok(credentials);
    } catch (cause) {
   ...
   */
  logout() {
    return this.getAuthenticatedUser().asyncAndThen(
      ({ authenticationId }) => revokeAuthentication(this, { authenticationId })
    ).andTee(
      () => types_star.ResultAsync.fromPromise(
        this.storage.reset(),
        (err3) => UnexpectedError.from(err3)
      )
    );
  }
  /**
  ...
  query(document, variables, requestPolicy = "cache-first") {
    ...
    ).andThen(this.handleAuthentication).map(takeValue);
  }
  /**
   * Execute a GraphQL mutation operation.
   *
  ...
  waitForTransaction = (txHash) => {
    return types_star.ResultAsync.fromPromise(
    ...
    while (Date.now() - startedAt < this.context.environment.indexingTimeout) {
      ...
      switch (result.value.__typename) {
        ...
        case "NotIndexedYetStatus":
          await delay2(this.context.environment.pollingInterval);
          break;
      }
    }
    ...
    const constantExchanges = [
      exchangeAuth.authExchange(async (utils) => {
        return {
          ...
          refreshAuth: async () => {
            const credentials = this.getCredentials().unwrapOr(null) ?? types_star.never("Missing refresh token");
            const result = await utils.mutate(graphql_star.RefreshMutation, {
              request: {
...
// src/test-utils.ts
var CHAIN = viem.chains.testnet;
var TEST_ACCOUNT = types_star.evmAddress(undefined.TEST_ACCOUNT);
var TEST_APP = types_star.evmAddress(undefined.TEST_APP);
var TEST_ERC20 = types_star.evmAddress(undefined.TEST_ERC20);
var PRIVATE_KEY = types_star.hexString(undefined.PRIVATE_KEY);
var GLOBAL_SPONSORSHIP = types_star.evmAddress(
  undefined.GLOBAL_SPONSORSHIP
);
var SPONSORSHIP_APPROVER_PRIVATE_KEY = types_star.hexString(
  undefined.SPONSORSHIP_APPROVER_PRIVATE_KEY
);
var signer = accounts.privateKeyToAccount(undefined.PRIVATE_KEY);
var environment = undefined.ENVIRONMENT === "local" ? src_exports.local : undefined.ENVIRONMENT === "staging" ? src_exports.staging : src_exports.testnet;
var wallet = viem$1.createWalletClient({
  account: signer,
  chain: CHAIN,
  transport: viem$1.http()
});
var TEST_SIGNER = types_star.evmAddress(signer.address);
function createPublicClient(config2 = {}) {
...
function loginAsAccountOwner(client = createPublicClient()) {
  return client.login({
    accountOwner: {
...
function loginAsOnboardingUser() {
...
var messages = {
  ["UNAUTHENTICATED" /* UNAUTHENTICATED */]: "Unauthenticated - Authentication is required to access '<operation>'",
  ["FORBIDDEN" /* FORBIDDEN */]: "Forbidden - You are not authorized to access '<operation>'",
  ["INTERNAL_SERVER_ERROR" /* INTERNAL_SERVER_ERROR */]: "Internal server error - Please try again later",
  ["BAD_USER_INPUT" /* BAD_USER_INPUT */]: "Bad user input - Please check the input and try again",
  ["BAD_REQUEST" /* BAD_REQUEST */]: "Bad request - Please check the request and try again"
};
function createGraphQLErrorObject(code) {
  return {
...
function dummyTextOnlyMetadata() {
  return Ws({
    content: "This is a post for testing purposes",
    locale: "en-US"
  });
}
function uploadImmutableTextOnlyPostMetadata() {
  const metadata = dummyTextOnlyMetadata();
  const acl2 = immutable(CHAIN.id);
  return storageClient.uploadAsJson(metadata, { acl: acl2 });
}
var acl = walletOnly(TEST_SIGNER, CHAIN.id);
function uploadTextOnlyPostMetadata() {
  const metadata = dummyTextOnlyMetadata();
  return storageClient.uploadAsJson(metadata, { acl });
}
function updateTextOnlyMetadata(uri, metadata) {
...
function mockAccessToken(claims) {
  const defaultClaims = {
    sub: types_star.evmAddress("0x391de77dB4c78a6f9358cf502A846357E0211942"),
    iss: "https://api.lens.dev",
    aud: "https://api.lens.dev",
    exp: Math.floor(Date.now() / 1e3) + 3600,
    // 1 hour expiration
    iat: Math.floor(Date.now() / 1e3),
    sid: types_star.uuid("00000000-0000-0000-0000-000000000000"),
    client_id: types_star.evmAddress("0xe163eEd7dBcDd3266677E7A8c53dCC05712253aA"),
    [SPONSORED_CLAIM]: false,
    [ROLE_CLAIM]: graphql_star.Role.Builder,
    ...claims
  };
  return createFakeJwt(defaultClaims);
}
...
function assertTypedDocumentSatisfies(document, rules) {
  globalExpect(graphql.validate(testUtils.schema, document, rules)).toEqual([]);
}
...
exports.CHAIN = CHAIN;
exports.GLOBAL_SPONSORSHIP = GLOBAL_SPONSORSHIP;
exports.PRIVATE_KEY = PRIVATE_KEY;
exports.SPONSORSHIP_APPROVER_PRIVATE_KEY = SPONSORSHIP_APPROVER_PRIVATE_KEY;
exports.TEST_ACCOUNT = TEST_ACCOUNT;
exports.TEST_APP = TEST_APP;
exports.TEST_ERC20 = TEST_ERC20;
exports.TEST_SIGNER = TEST_SIGNER;
exports.assertTypedDocumentSatisfies = assertTypedDocumentSatisfies;
exports.createGraphQLErrorObject = createGraphQLErrorObject;
exports.createPublicClient = createPublicClient;
exports.environment = environment;
exports.loginAsAccountOwner = loginAsAccountOwner;
exports.loginAsBuilder = loginAsBuilder;
exports.loginAsOnboardingUser = loginAsOnboardingUser;
exports.mockAccessToken = mockAccessToken;
exports.signer = signer;
exports.storageClient = storageClient;
exports.updateTextOnlyMetadata = updateTextOnlyMetadata;
exports.uploadImmutableTextOnlyPostMetadata = uploadImmutableTextOnlyPostMetadata;
exports.uploadTextOnlyPostMetadata = uploadTextOnlyPostMetadata;
